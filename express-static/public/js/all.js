...
!function (i) {
  ...
  i.fn.equalHeight = function () {
    ...
    return i.each(this, function (e, n) {
      var r, s = i(n), a = "border-box" === s.css("box-sizing") || "border-box" === s.css("-moz-box-sizing");
...
!function (t) {
  ...
  function g(t) {
    var e = t.data, n = d(t, e);
    n && X(t, e, n, l)
  }

  function h(t) {
    var e = t.data, n = c(t.changedTouches, e.identifier);
    n && l(e.identifier)
  }
  ...
  function X(t, e, n, a) {
    var i = n.pageX - e.startX, o = n.pageY - e.startY;
  ...
  function S(t) {
    var e = t.data.event, n = t.data.timer;
    k(), F(e, n, function () {
      setTimeout(function () {
        L(e.target, "click", i)
      }, 0)
  ...
  function _(t) {
    var e = t.data.event, n = t.data.timer, a = d(t, e);
    a && (t.preventDefault(), e.targetTouches = t.targetTouches, t.data.touch = a, t.data.timeStamp = t.timeStamp, n.kick())
  }

  function q(t) {
    var e = t.data.event, n = t.data.timer, a = c(t.changedTouches, e.identifier);
    a && (A(e), F(e, n))
  }
  ...
  var C = 6, K = t.event.add, L = t.event.remove, N = function (e, n, a) {
  ...
  }(), z = {textarea: !0, input: !0, select: !0, button: !0}, Q = {
    move: "mousemove",
    cancel: "mouseup dragstart",
    end: "mouseup"
  }, B = {move: "touchmove", cancel: "touchend", end: "touchend"};
  t.event.special.movestart = {
    setup: R, teardown: x, add: b, remove: j, _default: function (t) {
      function a() {
...
jQuery.fn.fastLiveFilter = function (e, t) {
  t = t || {}, e = jQuery(e);
  var n, l = this, i = "", o = t.timeout || 0, a = t.callback || function () {
    }, s = e.children(), r = s.length, c = r > 0 ? s[0].style.display : "block";
...
!function (e) {
  ...
  t.prototype = {
    activate: function () {
      ...
      {
        var e = this, t = this.getOption("playOn");
        this.getOption("mode")
      }
      switch (t) {
        case"click":
      ...
      var i = this.getGif(), n = this.previewElement.width(), s = this.previewElement.height();
      ...
      var t = this, i = this.getMp4(), n = this.getWebm(), s = this.previewElement.width(), o = this.previewElement.height();
  ...
  }, e.fn.gifplayer.defaults = {label: "GIF", playOn: "click", mode: "gif", gif: "", mp4: "", webm: "", wait: !1}
}(jQuery);
!function (e) {
...
!function (t) {
  t.fn.instaFilta = function (e) {
    var i = null, s = null, a = t.extend({
      ...
      typeDelay: 0,
      useSynonyms: !0,
      synonyms: [{src: "à,á,å,ä,â,ã", dst: "a"}, {src: "À,Á,Å,Ä,Â,Ã", dst: "A"}, {
        src: "è,é,ë,ê",
        dst: "e"
      }, {src: "È,É,Ë,Ê", dst: "E"}, {src: "ì,í,ï,î", dst: "i"}, {src: "Ì,Í,Ï,Î", dst: "I"}, {
        src: "ò,ó,ö,ô,õ",
        dst: "o"
      }, {src: "Ò,Ó,Ö,Ô,Õ", dst: "O"}, {src: "ù,ú,ü,û", dst: "u"}, {src: "Ù,Ú,Ü,Û", dst: "U"}, {
        src: "ç",
        dst: "c"
      }, {src: "Ç", dst: "C"}, {src: "æ", dst: "ae"}]
    }, e);
    if (a.useSynonyms)for (var n = 0, r = a.synonyms.length; r > n; n++)a.synonyms[n].src = a.synonyms[n].src.split(",");
    return this.each(function () {
      var e, n, r, o, c = "";
      a.scope ? (o = t(this).closest(a.scope), n = o.find(a.targets), r = o.find(a.sections)) : (n = t(a.targets), r = t(a.sections)), n.each(function () {
        $target = t(this), original = $target.text(), $target.data("values", function (t) {
          var e = [original], i = original;
          if (!a.useSynonyms)return e;
          for (var s = 0, n = t.length; n > s; s++)for (var r = 0; r < t[s].src.length; r++)i = i.replace(t[s].src[r], t[s].dst);
      ...
      i = function (e) {
        return e = a.caseSensitive ? e : e.toLowerCase(), c === e ? !1 : (c = e, e || u(), n.each(function () {
          ...
          var s = function (t, e) {
            ...
            return i
          }(i.data("values"), e), n = i.data("originalText"), r = (a.caseSensitive ? n : n.toLowerCase(), null), o = null;
        ...
        return e && e.length ? ("string" == typeof e && (e = e.split(",")), n.each(function () {
          var s = !0, n = 0, r = t(this), o = r.data(a.categoryDataAttr);
          if (o) {
            o = o.split(",");
            for (var c = 0; c < o.length; c++)for (var l = 0; l < e.length; l++)if (o[c] === e[l]) {
              if (!i) {
                s = !1;
                break
              }
...
!function (e) {
  ...
  function a(t, a) {
    var l = this, o = e(l);
    if (l.value == o.attr("placeholder") && o.hasClass(p.customClass))if (o.data("placeholder-password")) {
      ...
      if ("password" === r.type) {
        if (!o.data("placeholder-textinput")) {
          ...
          l.removeAttr("name").data({
            ...
            "placeholder-id": n
          }).bind("focus.placeholder", a), o.data({"placeholder-textinput": l, "placeholder-id": n}).before(l)
        }
  ...
  var o, n, s = "[object OperaMini]" == Object.prototype.toString.call(window.operamini), c = "placeholder"in document.createElement("input") && !s, u = "placeholder"in document.createElement("textarea") && !s, d = e.valHooks, i = e.propHooks;
  if (c && u)n = e.fn.placeholder = function () {
    ...
    n = e.fn.placeholder = function (t) {
      ...
      get: function (t) {
        var a = e(t), l = a.data("placeholder-password");
        return l ? l[0].value : a.data("placeholder-enabled") && a.hasClass(p.customClass) ? "" : t.value
      }, set: function (t, o) {
        var n = e(t), s = n.data("placeholder-password");
...
!function (n, e) {
  ...
  t.prototype.init = function () {
    ...
    var o = this, r = o.settings, c = o._getActionItems(e), d = 0;
...
!function (e, n) {
  ...
  function r(r, a, i) {
    var s = r.children(a.headerTag), o = r.children(a.bodyTag);
    s.length > o.length ? $(X, "contents") : s.length < o.length && $(X, "titles");
    var l = a.startIndex;
    if (i.stepCount = s.length, a.saveState && e.cookie) {
      var d = e.cookie(R + m(r)), u = parseInt(d, 0);
      !isNaN(u) && u < i.stepCount && (l = u)
    }
    i.currentIndex = l, s.each(function (a) {
      var i = e(this), s = o.eq(a), l = s.data("mode"), d = null == l ? Y.html : g(Y, /^\s*$/.test(l) || isNaN(l) ? l : parseInt(l, 0)), u = d === Y.html || s.data("url") === n ? "" : s.data("url"), c = d !== Y.html && "1" === s.data("loaded"), f = e.extend({}, nn, {
        title: i.html(),
  ...
  function s(n, t) {
    ...
    var i = e('<{0} class="{1}"></{0}>'.format(n.get(0).tagName, n.attr("class"))), s = n._id();
  ...
  function I(n) {
    ...
    return this.each(function () {
      var n = e(this), a = {currentIndex: t.startIndex, currentStep: null, stepCount: 0, transitionElement: null};
  ...
  function _(n, t, r, a, i) {
    ...
    var s = n.find(".content"), o = e("<{0}>{1}</{0}>".format(t.headerTag, i.title)), l = e("<{0}></{0}>".format(t.bodyTag));
    ...
    if (r.stepCount > 0) {
      ...
      if (!t.enableContentCache || !i.contentLoaded)switch (g(Y, i.contentMode)) {
        case Y.iframe:
          ...
          break;
        case Y.async:
          var s = u(n, a)._aria("busy", "true").empty().append(H(t.loadingTemplate, {text: t.labels.loading}));
  ...
  function T(e, n, t, r) {
    ...
    if (r >= 0 && r < t.stepCount && !(n.forceMoveForward && r < t.currentIndex)) {
      var i = d(e, r), s = i.parent(), o = s.hasClass("disabled");
  ...
  function k(n) {
    n.preventDefault();
    var t = e(this), r = t.parent().parent().parent().parent(), i = f(r), s = p(r), l = t.attr("href");
  ...
  function S(e, n, t) {
    if (n.enablePagination) {
      var r = e.find(".actions a[href$='#finish']").parent(), a = e.find(".actions a[href$='#next']").parent();
  ...
  function q(n, t, r, a) {
    var i = d(n, r.currentIndex), s = e('<span class="current-info audible">' + t.labels.current + " </span>"), o = n.find(".content > .title");
    if (null != a) {
      var l = d(n, a);
  ...
  function D(e, n, t, r) {
    for (var a = m(e), i = r; i < t.stepCount; i++) {
      var s = a + V + i, o = a + W + i, l = a + G + i, d = e.find(".title").eq(i)._id(l);
  ...
  function L(n, t, r) {
    var a = '<{0} class="{1}">{2}</{0}>', i = g(Z, t.stepsOrientation), s = i === Z.vertical ? " vertical" : "", o = e(a.format(t.contentContainerTag, "content " + t.clearFixCssClass, n.html())), l = e(a.format(t.stepsContainerTag, "steps " + t.clearFixCssClass, '<ul role="tablist"></ul>')), d = o.children(t.headerTag), u = o.children(t.bodyTag);
  ...
  function O(e, n, t, r) {
    var a = m(e), i = a + W + r, s = a + G + r;
    t._id(i).attr("role", "tabpanel")._aria("labelledby", s).addClass("body")._showAria(n.currentIndex === r)
  }

  function B(e, n, t) {
    if (n.enablePagination) {
      var r = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>', a = '<li><a href="#{0}" role="menuitem">{1}</a></li>', i = "";
  ...
  function H(e, t) {
    for (var r = e.match(/#([a-z]*)#/gi), a = 0; a < r.length; a++) {
      var i = r[a], s = i.substring(1, i.length - 1);
  ...
  function P(n, t, r, a, i) {
    var s = m(n), o = s + V + i, d = s + W + i, u = s + G + i, c = n.find(".steps > ul"), f = H(t.titleTemplate, {
      index: i + 1,
      title: a.html()
  ...
  function U(n, t, r, a, i, s) {
    var o = n.find(".content > .body"), l = g(en, t.transitionEffect), d = t.transitionEffectSpeed, u = o.eq(a), c = o.eq(i);
    switch (l) {
      case en.fade:
      case en.slide:
        var f = l === en.fade ? "fadeOut" : "slideUp", h = l === en.fade ? "fadeIn" : "slideDown";
        r.transitionElement = u, c[f](d, function () {
          var n = e(this)._showAria(!1).parent().parent(), t = p(n);
        ...
        break;
      case en.slideLeft:
        var v = c.outerWidth(!0), m = a > i ? -v : v, C = a > i ? v : -v;
        e.when(c.animate({left: m}, d, function () {
          e(this)._showAria(!1)
        }), u.css("left", C + "px")._showAria().animate({left: 0}, d)).done(s);
        break;
      default:
  ...
  function z(n) {
    n.preventDefault();
    var t = e(this), r = t.parent().parent().parent().parent(), a = f(r), i = p(r), s = i.currentIndex;
    if (t.parent().is(":not(.disabled):not(.current)")) {
      var o = t.attr("href"), l = parseInt(o.substring(o.lastIndexOf("-") + 1), 0);
      x(r, a, i, l)
    }
  ...
  var K = 0, R = "jQu3ry_5teps_St@te_", V = "-t-", W = "-p-", G = "-h-", J = "Index out of range.", X = "One or more corresponding step {0} are missing.";
  ...
  var Y = e.fn.steps.contentMode = {html: 0, iframe: 1, async: 2}, Z = e.fn.steps.stepsOrientation = {
    horizontal: 0,
    vertical: 1
...
!function (t) {
  t.fn.supersubs = function (i) {
    ...
    return this.each(function () {
      var i = t(this), s = t.meta ? t.extend({}, e, i.data()) : e, n = i.find("ul").show(), a = t('<li id="menu-fontsize">&#8212;</li>').css({
        padding: 0,
        position: "absolute",
        top: "-999em",
        width: "auto"
      ...
      t("#menu-fontsize").remove(), n.each(function () {
        var i = t(this), e = i.children(), n = e.children("a"), d = e.css("white-space", "nowrap").css("float");
        i.add(e).add(n).css({"float": "none", width: "auto"});
        ...
        h += s.extraWidth, h > s.maxWidth ? h = s.maxWidth : h < s.minWidth && (h = s.minWidth), h += "em", i.css("width", h), e.css({
          ...
          var i = t(this).children("ul"), e = void 0 !== i.css("left") ? "left" : "right";
          i.css(e, "100%")
        })
      }).hide()
    })
...
!function (n) {
  function e(e) {
    function i(e, i, a, t) {
      function l(e, i) {
        ...
        if (a = a || t.length > 0, a ? s.append(n("<span>").text(e.label)) : s.text(e.label), t.length > 0) {
          var d = "url(" + t[e.imageIndex] + ")", o = s.find("span");
          o.addClass("has-node-icon"), o.css("background-image", d)
        }
        if (void 0 != e.children && e.children.length > 0)for (var r = n("<ul>").appendTo(s), c = 0; c < e.children.length; c++) {
          var u = e.children[c];
          l(u, r)
        }
        return s
    ...
    return {
      init: function (t) {
        t = t || {};
        var l = {model: null, useSpan: !1, imageList: [], expanded: !1}, s = {};
...
!function (t) {
  t.fn.twentytwenty = function (e) {
    var e = t.extend({default_offset_pct: .5, orientation: "horizontal"}, e);
    return this.each(function () {
      var n = e.default_offset_pct, i = t(this), a = e.orientation, s = "vertical" === a ? "down" : "left", d = "vertical" === a ? "up" : "right";
      i.wrap("<div class='twentytwenty-wrapper twentytwenty-" + a + "'></div>"), i.append("<div class='twentytwenty-overlay'></div>");
      var r = i.find("img:first"), w = i.find("img:last");
...
(function (e, t) {
  ...
  var a = a || function (a, i) {
      var s = function () {
        ...
        playId: "",
        wmode: "opaque",
        events: {videoReady: s, stateChange: s}
      }, l = {}, o = {
        events: {
          ...
          var a = t.getElementsByTagName("head")[0], i = t.createElement("style");
          ...
          base: "https://www.googleapis.com/youtube/v3/", userInfo: function () {
        ...
        youtube: function () {
          ...
          if (e && e.items) {
            var t, a = '<div class="ytv-playlists"><ul>', i = e.items;
            for (t = 0; t < i.length; t++) {
              var s = {title: i[t].snippet.title, plid: i[t].id, thumb: i[t].snippet.thumbnails.medium.url};
            ...
            a += "</ul></div>";
            var l = n.element.getElementsByClassName("ytv-list-header")[0], o = l.children[0];
          ...
          e && e.items && o.ajax.get(o.endpoints.userInfo(), function (t) {
            ...
            for (n.channelId = t.items[0].id, n.currentPlaylist && (s.title += " &middot; " + n.currentPlaylist), i += '<div class="ytv-list-header">', i += '<a href="' + s.url + '" target="_blank">', i += '<img src="' + s.thumb + '">', i += '<span><i class="ytv-arrow down"></i>' + s.title + "</span>", i += "</a>", i += "</div>", i += '<div class="ytv-list-inner"><ul>', a = 0; a < l.length; a++)if (l[a].status.embeddable) {
              var v = {
              ...
              }, p = v.duration.match(/[0-9]+[HMS]/g), y = 0, u = 0, m = 0, g = "";
              p.forEach(function (e) {
                var t = e.charAt(e.length - 1), a = parseInt(e.slice(0, -1));
                switch (t) {
                  case"H":
                    y = a > 9 ? "" + a : "0" + a;
                    break;
        ...
        logic: {
          playerStateChange: function (e) {
            ...
            var s = n.element.getElementsByClassName("ytv-video")[0], o = n.element.getElementsByClassName("ytv-video-playerContainer").length;
            s.innerHTML = '<div id="ytv-video-player' + a + o + '" class="ytv-video-playerContainer"></div>', l.player = new YT.Player("ytv-video-player" + a + o, {
              videoId: e,
              events: {
                onReady: n.events.videoReady, onStateChange: function (e) {
                  if (0 === e.target.getPlayerState() && n.chainVideos) {
                    var t = n.element.getElementsByClassName("ytv-active")[0].nextSibling, a = t.children[0];
                    a.click()
                  }
          ...
          videoClick: function (e) {
            ...
            if (t && t.getAttribute("data-ytv-playlist-toggle")) {
              o.events.prevent(e);
              var a = n.element.getElementsByClassName("ytv-list-header")[0];
              -1 === a.className.indexOf("ytv-playlist-open") ? a.className += " ytv-playlist-open" : a.className = a.className.replace(" ytv-playlist-open", "")
            }
...
var Prism = function () {
    ...
    util: {
      ...
      extend: function (e, a) {
        ...
        for (var l in s)if (s.hasOwnProperty(l)) {
          if (l == a)for (var r in n)n.hasOwnProperty(r) && (o[r] = n[r]);
          o[l] = s[l]
        }
      ...
      if (l && (r = (l.className.match(e) || [, ""])[1], o = t.languages[r]), o) {
        ...
        if (u) {
          u = u.replace(/^(?:\r?\n|\r)/, "");
          var c = {element: n, language: r, grammar: o, code: u};
          if (t.hooks.run("before-highlight", c), i && self.Worker) {
            ...
            }, d.postMessage(JSON.stringify({language: c.language, code: c.code}))
      ...
      var n = t.Token, i = [e], s = a.rest;
      if (s) {
        for (var r in s)a[r] = s[r];
        delete a.rest
      }
      e:for (var r in a)if (a.hasOwnProperty(r) && a[r]) {
        var o = a[r];
        o = "Array" === t.util.type(o) ? o : [o];
        for (var l = 0; l < o.length; ++l) {
          var u = o[l], c = u.inside, d = !!u.lookbehind, g = 0, p = u.alias;
          u = u.pattern || u;
          for (var m = 0; m < i.length; m++) {
            ...
            if (!(b instanceof n)) {
              ...
              if (f) {
                d && (g = f[1].length);
                var h = f.index - 1 + g, f = f[0].slice(g), E = f.length, w = h + E, k = b.slice(0, h + 1), T = b.slice(w + 1), y = [m, 1];
                k && y.push(k);
      ...
      all: {}, add: function (e, a) {
        ...
        var n = t.hooks.all[e];
        if (n && n.length)for (var i, s = 0; i = n[s++];)i(a)
      }
    }
  ...
  if (a.stringify = function (e, n, i) {
    ...
    var a = JSON.parse(e.data), n = a.language, i = a.code;
...
"undefined" != typeof module && module.exports && (module.exports = Prism), Prism.languages.markup = {
  ...
  e.languages.coffeescript = e.languages.extend("javascript", {
    comment: t,
    string: [/'(?:\\?[\s\S])*?'/, {pattern: /"(?:\\?[\s\S])*?"/, inside: {interpolation: a}}],
    ...
    "multiline-comment": {
      pattern: /###[\s\S]+?###/,
      alias: "comment"
    }, "block-regex": {pattern: /\/{3}[\s\S]*?\/{3}/, alias: "regex", inside: {comment: t, interpolation: a}}
  ...
  var t = /\{\*[\w\W]+?\*\}|\{[\w\W]+?\}/g, a = "{literal}", n = "{/literal}", i = !1;
...
!function (t) {
  ...
  return function e(t, n, o) {
    ...
    1: [function (t, e) {
      (function (n) {
        var o = "undefined" != typeof n ? n : "undefined" != typeof window ? window : {}, r = t("min-document");
    ...
    4: [function (t, e) {
      var n = t("../internal/getNative"), o = n(Date, "now"), r = o || function () {
    ...
    5: [function (t, e) {
      function n(t, e, n) {
        ...
        function l(e, n) {
          n && clearTimeout(n), f = g = m = void 0, e && (b = r(), d = t.apply(v, h), g || f || (h = v = void 0))
        }

        function u() {
          var t = e - (r() - y);
          0 >= t || t > e ? l(m, f) : g = setTimeout(u, t)
        }
        ...
        function p() {
          if (h = arguments, y = r(), v = this, m = j && (g || !T), _ === !1)var n = T && !g; else {
            f || T || (b = y);
            var o = _ - (y - b), i = 0 >= o || o > _;
            i ? (f && (f = clearTimeout(f)), b = y, d = t.apply(v, h)) : f || (f = setTimeout(c, o))
          }
          return i && g ? g = clearTimeout(g) : g || e === _ || (g = setTimeout(u, e)), n && (i = !0, d = t.apply(v, h)), !i || g || f || (h = v = void 0), d
        }

        var h, f, d, y, v, g, m, b = 0, _ = !1, j = !0;
      ...
      var o = t("../lang/isObject"), r = t("../date/now"), i = "Expected a function", s = Math.max;
      e.exports = n
    ...
    7: [function (t, e) {
      ...
      var o = t("./debounce"), r = t("../lang/isObject"), i = "Expected a function";
      e.exports = n
    ...
    13: [function (t, e) {
      function n(t, e, p, h, f) {
        if (!a(t))return t;
        var d = s(e) && (i(e) || u(e)), y = d ? void 0 : c(e);
        return o(y || e, function (o, i) {
          if (y && (i = o, o = e[i]), l(o))h || (h = []), f || (f = []), r(t, e, i, n, p, h, f); else {
            var s = t[i], a = p ? p(s, o, i, t, e) : void 0, u = void 0 === a;
            u && (a = o), void 0 === a && (!d || i in t) || !u && (a === a ? a === s : s !== s) || (t[i] = a)
          }
        }), t
      }

      var o = t("./arrayEach"), r = t("./baseMergeDeep"), i = t("../lang/isArray"), s = t("./isArrayLike"), a = t("../lang/isObject"), l = t("./isObjectLike"), u = t("../lang/isTypedArray"), c = t("../object/keys");
      e.exports = n
    }, {
      "../lang/isArray": 30,
      "../lang/isObject": 33,
    ...
    14: [function (t, e) {
      function n(t, e, n, c, p, h, f) {
        for (var d = h.length, y = e[n]; d--;)if (h[d] == y)return void(t[n] = f[d]);
        var v = t[n], g = p ? p(v, y, n, t, e) : void 0, m = void 0 === g;
        m && (g = y, s(y) && (i(y) || l(y)) ? g = i(v) ? v : s(v) ? o(v) : [] : a(y) || r(y) ? g = r(v) ? u(v) : a(v) ? v : {} : m = !1), h.push(y), f.push(g), m ? t[n] = c(g, y, p, h, f) : (g === g ? g !== v : v === v) && (t[n] = g)
      }

      var o = t("./arrayCopy"), r = t("../lang/isArguments"), i = t("../lang/isArray"), s = t("./isArrayLike"), a = t("../lang/isPlainObject"), l = t("../lang/isTypedArray"), u = t("../lang/toPlainObject");
      e.exports = n
    }, {
      "../lang/isArguments": 29,
      "../lang/isArray": 30,
    ...
    17: [function (t, e) {
      ...
      var o = t("./bindCallback"), r = t("./isIterateeCall"), i = t("../function/restParam");
      e.exports = n
    ...
    19: [function (t, e) {
      var n = t("./baseProperty"), o = n("length");
      e.exports = o
    }, {"./baseProperty": 15}],
    20: [function (t, e) {
      function n(t, e) {
    ...
    24: [function (t, e) {
      ...
      var o = t("./isArrayLike"), r = t("./isIndex"), i = t("../lang/isObject");
      e.exports = n
    ...
    27: [function (t, e) {
      function n(t) {
        for (var e = l(t), n = e.length, u = n && t.length, p = !!u && s(u) && (r(t) || o(t) || a(t)), h = -1, f = []; ++h < n;) {
          var d = e[h];
          (p && i(d, u) || c.call(t, d)) && f.push(d)
        }
        return f
      }

      var o = t("../lang/isArguments"), r = t("../lang/isArray"), i = t("./isIndex"), s = t("./isLength"), a = t("../lang/isString"), l = t("../object/keysIn"), u = Object.prototype, c = u.hasOwnProperty;
      e.exports = n
    }, {
      "../lang/isArguments": 29,
      "../lang/isArray": 30,
    ...
    28: [function (t, e) {
      ...
      var o = t("../lang/isObject"), r = t("../lang/isString"), i = t("../support");
      e.exports = n
    ...
    29: [function (t, e) {
      ...
      var o = t("../internal/isArrayLike"), r = t("../internal/isObjectLike"), i = Object.prototype, s = i.hasOwnProperty, a = i.propertyIsEnumerable;
      e.exports = n
    }, {"../internal/isArrayLike": 21, "../internal/isObjectLike": 26}],
    30: [function (t, e) {
      var n = t("../internal/getNative"), o = t("../internal/isLength"), r = t("../internal/isObjectLike"), i = "[object Array]", s = Object.prototype, a = s.toString, l = n(Array, "isArray"), u = l || function (t) {
    ...
    31: [function (t, e) {
      ...
      var o = t("./isObject"), r = "[object Function]", i = Object.prototype, s = i.toString;
      e.exports = n
    }, {"./isObject": 33}],
    32: [function (t, e) {
      function n(t) {
      ...
      var o = t("./isFunction"), r = t("../internal/isHostObject"), i = t("../internal/isObjectLike"), s = /^\[object .+?Constructor\]$/, a = Object.prototype, l = Function.prototype.toString, u = a.hasOwnProperty, c = RegExp("^" + l.call(u).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
      e.exports = n
    ...
    34: [function (t, e) {
      ...
      var o = t("../internal/baseForIn"), r = t("./isArguments"), i = t("../internal/isHostObject"), s = t("../internal/isObjectLike"), a = t("../support"), l = "[object Object]", u = Object.prototype, c = u.hasOwnProperty, p = u.toString;
      e.exports = n
    }, {
    ...
    35: [function (t, e) {
      ...
      var o = t("../internal/isObjectLike"), r = "[object String]", i = Object.prototype, s = i.toString;
      e.exports = n
    }, {"../internal/isObjectLike": 26}],
    36: [function (t, e) {
      function n(t) {
        return r(t) && o(t.length) && !!O[P.call(t)]
      }

      var o = t("../internal/isLength"), r = t("../internal/isObjectLike"), i = "[object Arguments]", s = "[object Array]", a = "[object Boolean]", l = "[object Date]", u = "[object Error]", c = "[object Function]", p = "[object Map]", h = "[object Number]", f = "[object Object]", d = "[object RegExp]", y = "[object Set]", v = "[object String]", g = "[object WeakMap]", m = "[object ArrayBuffer]", b = "[object Float32Array]", _ = "[object Float64Array]", j = "[object Int8Array]", T = "[object Int16Array]", w = "[object Int32Array]", k = "[object Uint8Array]", x = "[object Uint8ClampedArray]", C = "[object Uint16Array]", E = "[object Uint32Array]", O = {};
      O[b] = O[_] = O[j] = O[T] = O[w] = O[k] = O[x] = O[C] = O[E] = !0, O[i] = O[s] = O[m] = O[a] = O[l] = O[u] = O[c] = O[p] = O[h] = O[f] = O[d] = O[y] = O[v] = O[g] = !1;
      var S = Object.prototype, P = S.toString;
      e.exports = n
    ...
    38: [function (t, e) {
      var n = t("../internal/getNative"), o = t("../internal/isArrayLike"), r = t("../lang/isObject"), i = t("../internal/shimKeys"), s = t("../support"), a = n(Object, "keys"), l = a ? function (t) {
    ...
    39: [function (t, e) {
      function n(t) {
        ...
        for (var n = t.constructor, o = -1, h = s(n) && n.prototype || w, f = h === t, d = Array(e), v = e > 0, g = p.enumErrorProps && (t === T || t instanceof Error), b = p.enumPrototypes && s(t); ++o < e;)d[o] = o + "";
        for (var O in t)b && "prototype" == O || g && ("message" == O || "name" == O) || v && a(O, e) || "constructor" == O && (f || !x.call(t, O)) || d.push(O);
        if (p.nonEnumShadows && t !== w) {
          var S = t === k ? _ : t === T ? y : C.call(t), P = E[S] || E[m];
          for (S == m && (h = w), e = j.length; e--;) {
            O = j[e];
            var M = P[O];
            f && M || (M ? !x.call(t, O) : t[O] === h[O]) || d.push(O)
          }
        }
        return d
      }

      var o = t("../internal/arrayEach"), r = t("../lang/isArguments"), i = t("../lang/isArray"), s = t("../lang/isFunction"), a = t("../internal/isIndex"), l = t("../internal/isLength"), u = t("../lang/isObject"), c = t("../lang/isString"), p = t("../support"), h = "[object Array]", f = "[object Boolean]", d = "[object Date]", y = "[object Error]", v = "[object Function]", g = "[object Number]", m = "[object Object]", b = "[object RegExp]", _ = "[object String]", j = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"], T = Error.prototype, w = Object.prototype, k = String.prototype, x = w.hasOwnProperty, C = w.toString, E = {};
      E[h] = E[d] = E[g] = {
        constructor: !0,
        toLocaleString: !0,
        toString: !0,
        valueOf: !0
      }, E[f] = E[_] = {constructor: !0, toString: !0, valueOf: !0}, E[y] = E[v] = E[b] = {
        constructor: !0,
        toString: !0
      }, E[m] = {constructor: !0}, o(j, function (t) {
        for (var e in E)if (x.call(E, e)) {
          var n = E[e];
          n[t] = x.call(n, t)
        }
      }), e.exports = n
    ...
    40: [function (t, e) {
      var n = t("../internal/baseMerge"), o = t("../internal/createAssigner"), r = o(n);
      e.exports = r
    }, {"../internal/baseMerge": 13, "../internal/createAssigner": 17}],
    41: [function (t, e) {
      var n = Array.prototype, o = Error.prototype, r = Object.prototype, i = r.propertyIsEnumerable, s = n.splice, a = {};
      !function (t) {
        var e = function () {
          this.x = t
        }, n = {0: t, length: t}, r = [];
    ...
    43: [function (t, e) {
      "use strict";
      var n = t("object-keys"), o = function (t) {
        return "undefined" != typeof t && null !== t
      }, r = "function" == typeof Symbol && "symbol" == typeof Symbol(), i = t("define-properties"), s = Object, a = Array.prototype.push, l = Object.prototype.propertyIsEnumerable, u = function (t) {
        if (!o(t))throw new TypeError("target must be an object");
        var e, i, u, c, p, h = s(t);
        for (e = 1; e < arguments.length; ++e) {
          if (i = s(arguments[e]), c = n(i), r && Object.getOwnPropertySymbols)for (p = Object.getOwnPropertySymbols(i), u = 0; u < p.length; ++u)l.call(i, p[u]) && a.call(c, p[u]);
          for (u = 0; u < c.length; ++u)h[c[u]] = i[c[u]]
        }
        return h
      };
      i(u, {
        shim: function () {
          ...
          return i(Object, {assign: u}, {assign: t}), Object.assign || u
        }
      }), e.exports = u
    }, {"define-properties": 44, "object-keys": 46}],
    44: [function (t, e) {
      "use strict";
      var n = t("object-keys"), o = t("foreach"), r = "function" == typeof Symbol && "symbol" == typeof Symbol(), i = Object.prototype.toString, s = function (t) {
      ...
      }, l = Object.defineProperty && a(), u = function (t, e, n, o) {
        ...
        var i = arguments.length > 2 ? arguments[2] : {}, s = n(e);
        r && (s = s.concat(Object.getOwnPropertySymbols(e))), o(s, function (n) {
          u(t, n, e[n], i[n])
        })
      };
      c.supportsDescriptors = !!l, e.exports = c
    }, {foreach: 45, "object-keys": 46}],
    45: [function (t, e) {
      var n = Object.prototype.hasOwnProperty, o = Object.prototype.toString;
      e.exports = function (t, e, r) {
        if ("[object Function]" !== o.call(e))throw new TypeError("iterator must be a function");
        var i = t.length;
        if (i === +i)for (var s = 0; i > s; s++)e.call(r, t[s], s, t); else for (var a in t)n.call(t, a) && e.call(r, t[a], a, t)
      }
    }, {}],
    46: [function (t, e) {
      "use strict";
      var n = Object.prototype.hasOwnProperty, o = Object.prototype.toString, r = Array.prototype.slice, i = t("./isArguments"), s = !{toString: null}.propertyIsEnumerable("toString"), a = function () {
      }.propertyIsEnumerable("prototype"), l = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"], u = function (t) {
        var e = t.constructor;
        ...
        for (var t in window)if (!c["$" + t] && n.call(window, t) && null !== window[t] && "object" == typeof window[t])try {
          u(window[t])
        } catch (e) {
          return !0
        }
        ...
        var e = null !== t && "object" == typeof t, r = "[object Function]" === o.call(t), u = i(t), c = e && "[object String]" === o.call(t), p = [];
        if (!e && !r && !u)throw new TypeError("Object.keys called on a non-object");
        var f = a && r;
        if (c && t.length > 0 && !n.call(t, 0))for (var d = 0; d < t.length; ++d)p.push(String(d));
        if (u && t.length > 0)for (var y = 0; y < t.length; ++y)p.push(String(y)); else for (var v in t)f && "prototype" === v || !n.call(t, v) || p.push(String(v));
        if (s)for (var g = h(t), m = 0; m < l.length; ++m)g && "constructor" === l[m] || !n.call(t, l[m]) || p.push(l[m]);
        return p
      };
      f.shim = function () {
        if (Object.keys) {
    ...
    50: [function (t, e) {
      ...
      function o(t, e) {
        ...
        var c = {body: void 0, headers: {}, statusCode: 0, method: v, url: y, rawRequest: p};
        ...
        var h, f, d, y = p.url = t.uri || t.url, v = p.method = t.method || "GET", g = t.body || t.data, m = p.headers = t.headers || {}, b = !!t.sync, _ = !1;
        if ("json"in t && (_ = !0, m.accept || m.Accept || (m.Accept = "application/json"), "GET" !== v && "HEAD" !== v && (m["content-type"] || m["Content-Type"] || (m["Content-Type"] = "application/json"), g = JSON.stringify(t.json))), p.onreadystatechange = r, p.onload = u, p.onerror = l, p.onprogress = function () {
          }, p.ontimeout = l, p.open(v, y, !b, t.username, t.password), b || (p.withCredentials = !!t.withCredentials), !b && t.timeout > 0 && (d = setTimeout(function () {
            f = !0, p.abort("timeout");
            var t = new Error("XMLHttpRequest timeout");
            t.code = "ETIMEDOUT", l(t)
          }, t.timeout)), p.setRequestHeader)for (h in m)m.hasOwnProperty(h) && p.setRequestHeader(h, m[h]); else if (t.headers && !n(t.headers))throw new Error("Headers cannot be set on an XDomainRequest object");
      ...
      var i = t("global/window"), s = t("once"), a = t("parse-headers");
    ...
    52: [function (t, e) {
      ...
      var s = t("is-function");
      e.exports = n;
      var a = Object.prototype.toString, l = Object.prototype.hasOwnProperty
    }, {"is-function": 53}],
    53: [function (t, e) {
      function n(t) {
        var e = o.call(t);
    ...
    55: [function (t, e) {
      var n = t("trim"), o = t("for-each"), r = function (t) {
      ...
      e.exports = function (t) {
        ...
        var e = {};
        return o(n(t).split("\n"), function (t) {
          var o = t.indexOf(":"), i = n(t.slice(0, o)).toLowerCase(), s = n(t.slice(o + 1));
    ...
    56: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var s = t("./button.js"), a = o(s), l = t("./component.js"), u = o(l), c = function (t) {
        function e(n, o) {
    ...
    57: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var a = t("./component"), l = r(a), u = t("./utils/dom.js"), c = o(u), p = t("./utils/events.js"), h = o(p), f = t("./utils/fn.js"), d = o(f), y = t("global/document"), v = r(y), g = t("object.assign"), m = r(g), b = function (t) {
        function e(n, o) {
        ...
        return s(e, t), e.prototype.createEl = function () {
          var e = arguments.length <= 0 || void 0 === arguments[0] ? "button" : arguments[0], n = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1], o = arguments.length <= 2 || void 0 === arguments[2] ? {} : arguments[2];
          n = m["default"]({className: this.buildCSSClass(), tabIndex: 0}, n), o = m["default"]({
            role: "button",
            type: "button",
            "aria-live": "polite"
          }, o);
          var r = t.prototype.createEl.call(this, e, n, o);
          return this.controlTextEl_ = c.createEl("span", {className: "vjs-control-text"}), r.appendChild(this.controlTextEl_), this.controlText(this.controlText_), r
          ...
          h.on(v["default"], "keydown", d.bind(this, this.handleKeyPress))
        }, e.prototype.handleKeyPress = function (t) {
          (32 === t.which || 13 === t.which) && (t.preventDefault(), this.handleClick(t))
        }, e.prototype.handleBlur = function () {
          h.off(v["default"], "keydown", d.bind(this, this.handleKeyPress))
        }, e
      }(l["default"]);
    ...
    58: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var s = t("global/window"), a = r(s), l = t("./utils/dom.js"), u = o(l), c = t("./utils/fn.js"), p = o(c), h = t("./utils/guid.js"), f = o(h), d = t("./utils/events.js"), y = o(d), v = t("./utils/log.js"), g = r(v), m = t("./utils/to-title-case.js"), b = r(m), _ = t("object.assign"), j = r(_), T = t("./utils/merge-options.js"), w = r(T), k = function () {
        function t(e, n, o) {
          if (i(this, t), this.player_ = !e && this.play ? e = this : e, this.options_ = w["default"]({}, this.options_), n = this.options_ = w["default"](this.options_, n), this.id_ = n.id || n.el && n.el.id, !this.id_) {
            ...
            this.id_ = r + "_component_" + f.newGUID()
          }
        ...
        return t.prototype.dispose = function () {
          ...
          var n = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1], o = void 0, r = void 0;
          if ("string" == typeof e) {
          ...
          return "string" == typeof t || Array.isArray(t) ? y.on(this.el_, t, p.bind(this, e)) : !function () {
            var r = t, i = e, s = p.bind(o, n), a = function () {
              return o.off(r, i, s)
            };
          ...
          return "string" == typeof t || Array.isArray(t) ? y.one(this.el_, t, p.bind(this, e)) : !function () {
            var i = t, s = e, a = p.bind(o, n), l = function u() {
    ...
    59: [function (t, e, n) {
      ...
      "../component.js": 58,
      "./fullscreen-toggle.js": 60,
      "./live-display.js": 61,
      "./mute-toggle.js": 62,
      "./play-toggle.js": 63,
      "./playback-rate-menu/playback-rate-menu-button.js": 64,
      "./progress-control/progress-control.js": 69,
      "./spacer-controls/custom-control-spacer.js": 71,
      "./text-track-controls/captions-button.js": 74,
      "./text-track-controls/chapters-button.js": 75,
      "./text-track-controls/subtitles-button.js": 78,
      "./time-controls/current-time-display.js": 81,
      "./time-controls/duration-display.js": 82,
      "./time-controls/remaining-time-display.js": 83,
      "./time-controls/time-divider.js": 84,
      "./volume-control/volume-control.js": 86,
      "./volume-menu-button.js": 88
    }],
    60: [function (t, e, n) {
      "use strict";
      function o(t) {
    ...
    61: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var a = t("../component"), l = r(a), u = t("../utils/dom.js"), c = o(u), p = function (t) {
        function e(n, o) {
    ...
    62: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var a = t("../button"), l = r(a), u = t("../component"), c = r(u), p = t("../utils/dom.js"), h = o(p), f = function (t) {
        function e(n, o) {
        ...
        return s(e, t), e.prototype.buildCSSClass = function () {
          ...
          var n = this.player_.muted() ? "Unmute" : "Mute", o = this.localize(n);
          this.controlText() !== o && this.controlText(o);
          for (var r = 0; 4 > r; r++)h.removeElClass(this.el_, "vjs-vol-" + r);
          h.addElClass(this.el_, "vjs-vol-" + e)
        }, e
      }(l["default"]);
      f.prototype.controlText_ = "Mute", c["default"].registerComponent("MuteToggle", f), n["default"] = f, e.exports = n["default"]
    }, {"../button": 57, "../component": 58, "../utils/dom.js": 118}],
    63: [function (t, e, n) {
      "use strict";
      function o(t) {
        return t && t.__esModule ? t : {"default": t}
    ...
    64: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var a = t("../../menu/menu-button.js"), l = r(a), u = t("../../menu/menu.js"), c = r(u), p = t("./playback-rate-menu-item.js"), h = r(p), f = t("../../component.js"), d = r(f), y = t("../../utils/dom.js"), v = o(y), g = function (t) {
        function e(n, o) {
        ...
        return s(e, t), e.prototype.createEl = function () {
          ...
          var t = new c["default"](this.player()), e = this.playbackRates();
          if (e)for (var n = e.length - 1; n >= 0; n--)t.addChild(new h["default"](this.player(), {rate: e[n] + "x"}));
          return t
      ...
      "../../component.js": 58,
      "../../menu/menu-button.js": 95,
      "../../menu/menu.js": 97,
      "../../utils/dom.js": 118,
      "./playback-rate-menu-item.js": 65
    }],
    65: [function (t, e, n) {
      "use strict";
      function o(t) {
      ...
      n.__esModule = !0;
      var s = t("../../menu/menu-item.js"), a = o(s), l = t("../../component.js"), u = o(l), c = function (t) {
        function e(n, o) {
          r(this, e);
          var i = o.rate, s = parseFloat(i, 10);
    ...
    }, {"../../component.js": 58, "../../menu/menu-item.js": 96}],
    66: [function (t, e, n) {
      "use strict";
      function o(t) {
        if (t && t.__esModule)return t;
      ...
      n.__esModule = !0;
      var a = t("../../component.js"), l = r(a), u = t("../../utils/dom.js"), c = o(u), p = function (t) {
        function e(n, o) {
        ...
        return s(e, t), e.prototype.createEl = function () {
          ...
          var t = this.player_.buffered(), e = this.player_.duration(), n = this.player_.bufferedEnd(), o = this.el_.children, r = function (t, e) {
            var n = t / e || 0;
            return 100 * (n >= 1 ? 1 : n) + "%"
          };
          this.el_.style.width = r(n, e);
          for (var i = 0; i < t.length; i++) {
            var s = t.start(i), a = t.end(i), l = o[i];
    ...
    }, {"../../component.js": 58, "../../utils/dom.js": 118}],
    67: [function (t, e, n) {
      "use strict";
      function o(t) {
        if (t && t.__esModule)return t;
      ...
      n.__esModule = !0;
      var a = t("../../component.js"), l = r(a), u = t("../../utils/dom.js"), c = o(u), p = t("../../utils/fn.js"), h = o(p), f = t("../../utils/format-time.js"), d = r(f), y = t("lodash-compat/function/throttle"), v = r(y), g = function (t) {
        function e(n, o) {
          var r = this;
          i(this, e), t.call(this, n, o), this.update(0, 0), n.on("ready", function () {
            r.on(n.controlBar.progressControl.el(), "mousemove", v["default"](h.bind(r, r.handleMouseMove), 25))
          })
        }
        ...
        return s(e, t), e.prototype.createEl = function () {
          ...
          var e = this.player_.duration(), n = this.calculateDistance(t) * e, o = t.pageX - c.findElPosition(this.el().parentNode).left;
          this.update(n, o)
    ...
    68: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var a = t("../../component.js"), l = r(a), u = t("../../utils/fn.js"), c = o(u), p = t("../../utils/format-time.js"), h = r(p), f = function (t) {
        function e(n, o) {
      ...
      l["default"].registerComponent("PlayProgressBar", f), n["default"] = f, e.exports = n["default"]
    }, {"../../component.js": 58, "../../utils/fn.js": 120, "../../utils/format-time.js": 121}],
    69: [function (t, e, n) {
      "use strict";
      function o(t) {
        return t && t.__esModule ? t : {"default": t}
      ...
      n.__esModule = !0;
      var s = t("../../component.js"), a = o(s), l = t("./seek-bar.js"), u = (o(l), t("./mouse-time-display.js")), c = (o(u), function (t) {
        function e() {
          r(this, e), t.apply(this, arguments)
        }
      ...
      c.prototype.options_ = {children: ["seekBar"]}, a["default"].registerComponent("ProgressControl", c), n["default"] = c, e.exports = n["default"]
    }, {"../../component.js": 58, "./mouse-time-display.js": 67, "./seek-bar.js": 70}],
    70: [function (t, e, n) {
      "use strict";
      function o(t) {
        if (t && t.__esModule)return t;
      ...
      n.__esModule = !0;
      var a = t("../../slider/slider.js"), l = r(a), u = t("../../component.js"), c = r(u), p = t("./load-progress-bar.js"), h = (r(p), t("./play-progress-bar.js")), f = (r(h), t("../../utils/fn.js")), d = o(f), y = t("../../utils/format-time.js"), v = r(y), g = t("object.assign"), m = (r(g), function (t) {
        function e(n, o) {
          i(this, e), t.call(this, n, o), this.on(n, "timeupdate", this.updateARIAAttributes), n.ready(d.bind(this, this.updateARIAAttributes))
        }

        return s(e, t), e.prototype.createEl = function () {
          return t.prototype.createEl.call(this, "div", {className: "vjs-progress-holder"}, {"aria-label": "video progress bar"})
        }, e.prototype.updateARIAAttributes = function () {
          var t = this.player_.scrubbing() ? this.player_.getCache().currentTime : this.player_.currentTime();
      ...
      "../../component.js": 58,
      "../../slider/slider.js": 102,
      "../../utils/fn.js": 120,
      "../../utils/format-time.js": 121,
      "./load-progress-bar.js": 66,
      "./play-progress-bar.js": 68,
      "object.assign": 43
    }],
    71: [function (t, e, n) {
      "use strict";
      ...
      n.__esModule = !0;
      var s = t("./spacer.js"), a = o(s), l = t("../../component.js"), u = o(l), c = function (t) {
        function e() {
          r(this, e), t.apply(this, arguments)
        }
    ...
    73: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var s = t("./text-track-menu-item.js"), a = o(s), l = t("../../component.js"), u = o(l), c = function (t) {
        function e(n, o) {
          r(this, e), o.track = {
            kind: o.kind,
            player: n,
    ...
    }, {"../../component.js": 58, "./text-track-menu-item.js": 80}],
    74: [function (t, e, n) {
      "use strict";
      function o(t) {
        return t && t.__esModule ? t : {"default": t}
      ...
      n.__esModule = !0;
      var s = t("./text-track-button.js"), a = o(s), l = t("../../component.js"), u = o(l), c = t("./caption-settings-menu-item.js"), p = o(c), h = function (t) {
        function e(n, o, i) {
        ...
        return i(e, t), e.prototype.buildCSSClass = function () {
          ...
          var e = [];
          return this.player().tech_ && this.player().tech_.featuresNativeTextTracks || e.push(new p["default"](this.player_, {kind: this.kind_})), t.prototype.createItems.call(this, e)
        }, e
      }(a["default"]);
      h.prototype.kind_ = "captions", h.prototype.controlText_ = "Captions", u["default"].registerComponent("CaptionsButton", h), n["default"] = h, e.exports = n["default"]
    }, {"../../component.js": 58, "./caption-settings-menu-item.js": 73, "./text-track-button.js": 79}],
    75: [function (t, e, n) {
      "use strict";
      function o(t) {
        if (t && t.__esModule)return t;
      ...
      n.__esModule = !0;
      var a = t("./text-track-button.js"), l = r(a), u = t("../../component.js"), c = r(u), p = t("./text-track-menu-item.js"), h = r(p), f = t("./chapters-track-menu-item.js"), d = r(f), y = t("../../menu/menu.js"), v = r(y), g = t("../../utils/dom.js"), m = o(g), b = t("../../utils/fn.js"), _ = o(b), j = t("../../utils/to-title-case.js"), T = r(j), w = t("global/window"), k = r(w), x = function (t) {
        function e(n, o, r) {
        ...
        return s(e, t), e.prototype.buildCSSClass = function () {
          ...
          for (var n = 0; n < e.length; n++) {
            var o = e[n];
            o.kind === this.kind_ && t.push(new h["default"](this.player_, {track: o}))
          }
          return t
        }, e.prototype.createMenu = function () {
          ...
          if (void 0 === s && (s = new v["default"](this.player_), s.contentEl().appendChild(m.createEl("li", {
            ...
            for (var a = e.cues, l = void 0, o = 0, r = a.length; r > o; o++) {
              l = a[o];
              var u = new d["default"](this.player_, {track: e, cue: l});
      ...
      "../../utils/fn.js": 120,
      "../../utils/to-title-case.js": 127,
      "./chapters-track-menu-item.js": 76,
      "./text-track-button.js": 79,
      "./text-track-menu-item.js": 80,
      "global/window": 2
    }],
    76: [function (t, e, n) {
      "use strict";
      ...
      n.__esModule = !0;
      var a = t("../../menu/menu-item.js"), l = r(a), u = t("../../component.js"), c = r(u), p = t("../../utils/fn.js"), h = o(p), f = function (t) {
        function e(n, o) {
          i(this, e);
          var r = o.track, s = o.cue, a = n.currentTime();
          o.label = s.text, o.selected = s.startTime <= a && a < s.endTime, t.call(this, n, o), this.track = r, this.cue = s, r.addEventListener("cuechange", h.bind(this, this.update))
        }
      ...
      c["default"].registerComponent("ChaptersTrackMenuItem", f), n["default"] = f, e.exports = n["default"]
    }, {"../../component.js": 58, "../../menu/menu-item.js": 96, "../../utils/fn.js": 120}],
    77: [function (t, e, n) {
      "use strict";
      function o(t) {
        return t && t.__esModule ? t : {"default": t}
    ...
    78: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var s = t("./text-track-button.js"), a = o(s), l = t("../../component.js"), u = o(l), c = function (t) {
        function e(n, o, i) {
    ...
    }, {"../../component.js": 58, "./text-track-button.js": 79}],
    79: [function (t, e, n) {
      "use strict";
      function o(t) {
        if (t && t.__esModule)return t;
      ...
      n.__esModule = !0;
      var a = t("../../menu/menu-button.js"), l = r(a), u = t("../../component.js"), c = r(u), p = t("../../utils/fn.js"), h = o(p), f = t("./text-track-menu-item.js"), d = r(f), y = t("./off-text-track-menu-item.js"), v = r(y), g = function (t) {
        function e(n, o) {
          i(this, e), t.call(this, n, o);
          var r = this.player_.textTracks();
          if (this.items.length <= 1 && this.hide(), r) {
            var s = h.bind(this, this.update);
        ...
        return s(e, t), e.prototype.createItems = function () {
          ...
          t.push(new v["default"](this.player_, {kind: this.kind_}));
          var e = this.player_.textTracks();
          if (!e)return t;
          for (var n = 0; n < e.length; n++) {
            var o = e[n];
            o.kind === this.kind_ && t.push(new d["default"](this.player_, {track: o}))
          }
          return t
        }, e
      }(l["default"]);
      ...
      "../../menu/menu-button.js": 95,
      "../../utils/fn.js": 120,
      "./off-text-track-menu-item.js": 77,
      "./text-track-menu-item.js": 80
    }],
    80: [function (t, e, n) {
      "use strict";
      ...
      n.__esModule = !0;
      var a = t("../../menu/menu-item.js"), l = r(a), u = t("../../component.js"), c = r(u), p = t("../../utils/fn.js"), h = o(p), f = t("global/window"), d = r(f), y = t("global/document"), v = r(y), g = function (t) {
        function e(n, o) {
          var r = this;
          i(this, e);
          ...
          o.label = s.label || s.language || "Unknown", o.selected = s["default"] || "showing" === s.mode, t.call(this, n, o), this.track = s, a && !function () {
            var t = h.bind(r, r.handleTracksChange);
        ...
        return s(e, t), e.prototype.handleClick = function (e) {
          ...
          if (t.prototype.handleClick.call(this, e), o)for (var r = 0; r < o.length; r++) {
            var i = o[r];
    ...
    81: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var a = t("../../component.js"), l = r(a), u = t("../../utils/dom.js"), c = o(u), p = t("../../utils/format-time.js"), h = r(p), f = function (t) {
        function e(n, o) {
        ...
        return s(e, t), e.prototype.createEl = function () {
          ...
          var t = this.player_.scrubbing() ? this.player_.getCache().currentTime : this.player_.currentTime(), e = this.localize("Current Time"), n = h["default"](t, this.player_.duration());
    ...
    }, {"../../component.js": 58, "../../utils/dom.js": 118, "../../utils/format-time.js": 121}],
    82: [function (t, e, n) {
      "use strict";
      function o(t) {
        if (t && t.__esModule)return t;
      ...
      var a = t("../../component.js"), l = r(a), u = t("../../utils/dom.js"), c = o(u), p = t("../../utils/format-time.js"), h = r(p), f = function (t) {
        ...
        return s(e, t), e.prototype.createEl = function () {
          ...
          if (t) {
            var e = this.localize("Duration Time"), n = h["default"](t);
            this.contentEl_.innerHTML = '<span class="vjs-control-text">' + e + "</span> " + n
          }
        }, e
      }(l["default"]);
      ...
      var a = t("../../component.js"), l = r(a), u = t("../../utils/dom.js"), c = o(u), p = t("../../utils/format-time.js"), h = r(p), f = function (t) {
        ...
        return s(e, t), e.prototype.createEl = function () {
          ...
          if (this.player_.duration()) {
            var t = this.localize("Remaining Time"), e = h["default"](this.player_.remainingTime());
    ...
    85: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var a = t("../../slider/slider.js"), l = r(a), u = t("../../component.js"), c = r(u), p = t("../../utils/fn.js"), h = o(p), f = t("./volume-level.js"), d = (r(f), function (t) {
        function e(n, o) {
          i(this, e), t.call(this, n, o), this.on(n, "volumechange", this.updateARIAAttributes), n.ready(h.bind(this, this.updateARIAAttributes))
        }
    ...
    }, {"../../component.js": 58, "../../slider/slider.js": 102, "../../utils/fn.js": 120, "./volume-level.js": 87}],
    86: [function (t, e, n) {
      "use strict";
      function o(t) {
        return t && t.__esModule ? t : {"default": t}
      ...
      n.__esModule = !0;
      var s = t("../../component.js"), a = o(s), l = t("./volume-bar.js"), u = (o(l), function (t) {
        function e(n, o) {
      ...
      u.prototype.options_ = {children: ["volumeBar"]}, a["default"].registerComponent("VolumeControl", u), n["default"] = u, e.exports = n["default"]
    }, {"../../component.js": 58, "./volume-bar.js": 85}],
    87: [function (t, e, n) {
      "use strict";
      function o(t) {
        return t && t.__esModule ? t : {"default": t}
    ...
    88: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var s = t("../button.js"), a = (o(s), t("../component.js")), l = o(a), u = t("../menu/menu.js"), c = o(u), p = t("../menu/menu-button.js"), h = o(p), f = t("./mute-toggle.js"), d = o(f), y = t("./volume-control/volume-bar.js"), v = o(y), g = function (t) {
        function e(n) {
          function o() {
        ...
        return i(e, t), e.prototype.buildCSSClass = function () {
          ...
          var t = new c["default"](this.player_, {contentElType: "div"}), e = new v["default"](this.player_, this.options_.volumeBar);
      ...
      "../menu/menu.js": 97,
      "./mute-toggle.js": 62,
      "./volume-control/volume-bar.js": 85
    }],
    89: [function (t, e, n) {
      "use strict";
      function o(t) {
      ...
      var a = t("./component"), l = r(a), u = t("./utils/dom.js"), c = o(u), p = function (t) {
        ...
        return s(e, t), e.prototype.createEl = function () {
          var e = t.prototype.createEl.call(this, "div", {className: "vjs-error-display"});
    ...
    90: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var r = t("./utils/events.js"), i = o(r), s = function () {
      };
    ...
    91: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var r = t("./utils/log"), i = o(r), s = function (t, e) {
        if ("function" != typeof e && null !== e)throw new TypeError("Super expression must either be null or a function, not " + typeof e);
        t.prototype = Object.create(e && e.prototype, {
          constructor: {
            value: t,
    ...
    92: [function (t, e, n) {
      ...
      if (u)for (var c = 0; c < u.length; c++)s[l[c]] = u[c];
    ...
    93: [function (t, e, n) {
      ...
      var s = t("./component"), a = o(s), l = function (t) {
        ...
        return i(e, t), e.prototype.createEl = function () {
          return t.prototype.createEl.call(this, "div", {className: "vjs-loading-spinner"})
        }, e
      }(a["default"]);
    ...
    94: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var r = t("object.assign"), i = o(r), s = function l(t) {
    ...
    95: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var a = t("../button.js"), l = r(a), u = t("../component.js"), c = r(u), p = t("./menu.js"), h = r(p), f = t("../utils/dom.js"), d = o(f), y = t("../utils/fn.js"), v = o(y), g = t("../utils/to-title-case.js"), m = r(g), b = function (t) {
        function e(n) {
    ...
    96: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var s = t("../button.js"), a = o(s), l = t("../component.js"), u = o(l), c = t("object.assign"), p = o(c), h = function (t) {
        function e(n, o) {
      ...
      u["default"].registerComponent("MenuItem", h), n["default"] = h, e.exports = n["default"]
    }, {"../button.js": 57, "../component.js": 58, "object.assign": 43}],
    97: [function (t, e, n) {
      "use strict";
      function o(t) {
        if (t && t.__esModule)return t;
      ...
      n.__esModule = !0;
      var a = t("../component.js"), l = r(a), u = t("../utils/dom.js"), c = o(u), p = t("../utils/fn.js"), h = o(p), f = t("../utils/events.js"), d = o(f), y = function (t) {
        function e() {
        ...
        return s(e, t), e.prototype.addItem = function (t) {
          ...
          this.contentEl_ = c.createEl(e, {className: "vjs-menu-content"});
    ...
    }, {"../component.js": 58, "../utils/dom.js": 118, "../utils/events.js": 119, "../utils/fn.js": 120}],
    98: [function (t, e, n) {
      "use strict";
      function o(t) {
        if (t && t.__esModule)return t;
      ...
      n.__esModule = !0;
      var a = t("./component.js"), l = r(a), u = t("global/document"), c = r(u), p = t("global/window"), h = r(p), f = t("./utils/events.js"), d = o(f), y = t("./utils/dom.js"), v = o(y), g = t("./utils/fn.js"), m = o(g), b = t("./utils/guid.js"), _ = o(b), j = t("./utils/browser.js"), T = (o(j), t("./utils/log.js")), w = r(T), k = t("./utils/to-title-case.js"), x = r(k), C = t("./utils/time-ranges.js"), E = t("./utils/buffer.js"), O = t("./utils/stylesheet.js"), S = o(O), P = t("./fullscreen-api.js"), M = r(P), A = t("./media-error.js"), I = r(A), R = t("safe-json-parse/tuple"), D = r(R), F = t("object.assign"), N = r(F), L = t("./utils/merge-options.js"), B = r(L), H = t("./tracks/text-track-list-converter.js"), V = r(H), U = t("./tech/loader.js"), q = (r(U), t("./poster-image.js")), W = (r(q), t("./tracks/text-track-display.js")), z = (r(W), t("./loading-spinner.js")), X = (r(z), t("./big-play-button.js")), G = (r(X), t("./control-bar/control-bar.js")), $ = (r(G), t("./error-display.js")), Y = (r($), t("./tracks/text-track-settings.js")), K = (r(Y), t("./tech/html5.js")), J = (r(K), function (t) {
        function e(n, o, r) {
          var s = this;
        ...
        return s(e, t), e.prototype.dispose = function () {
          ...
          var r = c["default"].querySelector(".vjs-styles-defaults"), i = c["default"].querySelector("head");
          ...
          for (var e = 0, n = this.options_.techOrder; e < n.length; e++) {
            var o = x["default"](n[e]), r = l["default"].getComponent(o);
            if (r) {
              if (r.isSupported())for (var i = 0, s = t; i < s.length; i++) {
                var a = s[i];
                if (r.canPlaySource(a))return {source: a, tech: o}
              }
          ...
          return Array.isArray(t) ? this.sourceList_(t) : "string" == typeof t ? this.src({src: t}) : t instanceof Object && (t.type && !e.canPlaySource(t) ? this.sourceList_([t]) : (this.cache_.src = t.src, this.currentType_ = t.type || "", this.ready(function () {
          ...
          var t = void 0, e = void 0, n = void 0, o = m.bind(this, this.reportUserActivity), r = function (t) {
          ...
          var t = B["default"](this.options_), e = t.tracks;
          t.tracks = [];
          for (var n = 0; n < e.length; n++) {
            var o = e[n];
          ...
          if (null !== o) {
            var r = D["default"](o || "{}"), i = r[0], s = r[1];
            i && w["default"].error(i), N["default"](n, s)
          }
          if (N["default"](e, n), t.hasChildNodes())for (var a = t.childNodes, l = 0, u = a.length; u > l; l++) {
      ...
      "./big-play-button.js": 56,
      "./component.js": 58,
      "./control-bar/control-bar.js": 59,
      "./error-display.js": 89,
      "./fullscreen-api.js": 92,
      "./loading-spinner.js": 93,
      "./media-error.js": 94,
      "./poster-image.js": 100,
      "./tech/html5.js": 105,
      "./tech/loader.js": 106,
      "./tracks/text-track-display.js": 109,
      "./tracks/text-track-list-converter.js": 111,
      "./tracks/text-track-settings.js": 113,
      "./utils/browser.js": 115,
      "./utils/buffer.js": 116,
      "./utils/dom.js": 118,
      "./utils/events.js": 119,
      "./utils/fn.js": 120,
      ...
      "./utils/log.js": 123,
      "./utils/merge-options.js": 124,
      "./utils/stylesheet.js": 125,
      "./utils/time-ranges.js": 126,
      "./utils/to-title-case.js": 127,
      "global/document": 1,
      "global/window": 2,
      "object.assign": 43,
      "safe-json-parse/tuple": 48
    }],
    99: [function (t, e, n) {
      "use strict";
      function o(t) {
      ...
      n.__esModule = !0;
      var r = t("./player.js"), i = o(r), s = function (t, e) {
    ...
    100: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var a = t("./button.js"), l = r(a), u = t("./component.js"), c = r(u), p = t("./utils/fn.js"), h = o(p), f = t("./utils/dom.js"), d = o(f), y = t("./utils/browser.js"), v = o(y), g = function (t) {
        function e(n, o) {
          i(this, e), t.call(this, n, o), this.update(), n.on("posterchange", h.bind(this, this.update))
        }

        return s(e, t), e.prototype.dispose = function () {
          this.player().off("posterchange", this.update), t.prototype.dispose.call(this)
        }, e.prototype.createEl = function () {
          var t = d.createEl("div", {className: "vjs-poster", tabIndex: -1});
    ...
    101: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var i = t("./utils/events.js"), s = r(i), a = t("global/document"), l = o(a), u = t("global/window"), c = o(u), p = !1, h = void 0, f = function () {
        var t = l["default"].getElementsByTagName("video"), e = l["default"].getElementsByTagName("audio"), n = [];
        if (t && t.length > 0)for (var o = 0, r = t.length; r > o; o++)n.push(t[o]);
        if (e && e.length > 0)for (var o = 0, r = e.length; r > o; o++)n.push(e[o]);
      ...
      n.autoSetup = f, n.autoSetupTimeout = d, n.hasLoaded = y
    }, {"./utils/events.js": 119, "global/document": 1, "global/window": 2}],
    102: [function (t, e, n) {
      "use strict";
      function o(t) {
        if (t && t.__esModule)return t;
      ...
      n.__esModule = !0;
      var a = t("../component.js"), l = r(a), u = t("../utils/dom.js"), c = o(u), p = t("global/document"), h = r(p), f = t("object.assign"), d = r(f), y = function (t) {
        function e(n, o) {
        ...
        return s(e, t), e.prototype.createEl = function (e) {
          ...
          return n.className = n.className + " vjs-slider", n = d["default"]({tabIndex: 0}, n), o = d["default"]({
            role: "slider",
            "aria-valuenow": 0,
            "aria-valuemin": 0,
            "aria-valuemax": 100,
          ...
          c.unblockTextSelection(), this.removeClass("vjs-sliding"), this.trigger("sliderinactive"), this.off(h["default"], "mousemove", this.handleMouseMove), this.off(h["default"], "mouseup", this.handleMouseUp), this.off(h["default"], "touchmove", this.handleMouseMove), this.off(h["default"], "touchend", this.handleMouseUp), this.update()
        }, e.prototype.update = function () {
          if (this.el_) {
          ...
          this.on(h["default"], "keydown", this.handleKeyPress)
        }, e.prototype.handleKeyPress = function (t) {
          37 === t.which || 40 === t.which ? (t.preventDefault(), this.stepBack()) : (38 === t.which || 39 === t.which) && (t.preventDefault(), this.stepForward())
        }, e.prototype.handleBlur = function () {
          this.off(h["default"], "keydown", this.handleKeyPress)
    ...
    }, {"../component.js": 58, "../utils/dom.js": 118, "global/document": 1, "object.assign": 43}],
    103: [function (t, e, n) {
      "use strict";
      function o(t) {
    ...
    104: [function (t, e, n) {
      ...
      n.__esModule = !0;
      for (var u = t("./tech"), c = r(u), p = t("../utils/dom.js"), h = o(p), f = t("../utils/url.js"), d = o(f), y = t("../utils/time-ranges.js"), v = t("./flash-rtmp"), g = r(v), m = t("../component"), b = r(m), _ = t("global/window"), j = r(_), T = t("object.assign"), w = r(T), k = j["default"].navigator, x = function (t) {
        function e(n, o) {
        ...
        return s(e, t), e.prototype.createEl = function () {
          ...
          var n = t.techId, o = w["default"]({
            ...
            loop: t.loop,
            muted: t.muted
          }, t.flashVars), r = w["default"]({wmode: "opaque", bgcolor: "#000000"}, t.params), i = w["default"]({
            id: n,
            name: n,
            "class": "vjs-tech"
          }, t.attributes);
      ...
      x.isSupported = function () {
      ...
      }, x.registerSourceHandler(x.nativeSourceHandler), x.formats = {
        "video/flv": "FLV",
        "video/x-flv": "FLV",
        "video/mp4": "MP4",
        "video/m4v": "MP4"
      }, x.onReady = function (t) {
        var e = h.getEl(t), n = e && e.tech;
        ...
        var r = x.getEmbedCode(t, e, n, o), i = h.createEl("div", {innerHTML: r}).childNodes[0];
        return i
    ...
    105: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var a = t("./tech.js"), l = r(a), u = t("../component"), c = r(u), p = t("../utils/dom.js"), h = o(p), f = t("../utils/url.js"), d = o(f), y = t("../utils/fn.js"), v = o(y), g = t("../utils/log.js"), m = r(g), b = t("../utils/browser.js"), _ = o(b), j = t("global/document"), T = r(j), w = t("global/window"), k = r(w), x = t("object.assign"), C = r(x), E = t("../utils/merge-options.js"), O = r(E), S = function (t) {
        function e(n, o) {
          i(this, e), t.call(this, n, o);
          var r = n.source;
          if (r && (this.el_.currentSrc !== r.src || n.tag && 3 === n.tag.initNetworkState_) ? this.setSource(r) : this.handleLateInit_(this.el_), this.el_.hasChildNodes()) {
            for (var s = this.el_.childNodes, a = s.length, l = []; a--;) {
              var u = s[a], c = u.nodeName.toLowerCase();
        ...
        return s(e, t), e.prototype.dispose = function () {
          var n = this.el().textTracks, o = this.textTracks();
          ...
          if (!t || this.movingMediaElementInDOM === !1)if (t) {
            ...
            var o = this.options_.tag && h.getElAttributes(this.options_.tag), r = O["default"]({}, o);
            _.TOUCH_ENABLED && this.options_.nativeControlsForTouch === !0 || delete r.controls, h.setElAttributes(t, C["default"](r, {
      ...
      }, S.registerSourceHandler(S.nativeSourceHandler), S.canControlVolume = function () {
      ...
      var M = void 0, A = /^application\/(?:x-|vnd\.apple\.)mpegurl/i, I = /^video\/mp4/i;
    ...
    106: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var s = t("../component"), a = o(s), l = t("global/window"), u = (o(l), t("../utils/to-title-case.js")), c = o(u), p = function (t) {
        function e(n, o, i) {
          if (r(this, e), t.call(this, n, o, i), o.playerOptions.sources && 0 !== o.playerOptions.sources.length)n.src(o.playerOptions.sources); else for (var s = 0, l = o.playerOptions.techOrder; s < l.length; s++) {
            var u = c["default"](l[s]), p = a["default"].getComponent(u);
            if (p && p.isSupported()) {
              n.loadTech_(u);
              break
            }
    ...
    }, {"../component": 58, "../utils/to-title-case.js": 127, "global/window": 2}],
    107: [function (t, e, n) {
      "use strict";
      function o(t) {
        if (t && t.__esModule)return t;
      ...
      n.__esModule = !0;
      var a = t("../component"), l = r(a), u = t("../tracks/text-track"), c = r(u), p = t("../tracks/text-track-list"), h = r(p), f = t("../utils/fn.js"), d = o(f), y = t("../utils/log.js"), v = r(y), g = t("../utils/time-ranges.js"), m = t("../utils/buffer.js"), b = t("../media-error.js"), _ = r(b), j = t("global/window"), T = r(j), w = t("global/document"), k = r(w), x = function (t) {
        function e() {
          var n = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0], o = arguments.length <= 1 || void 0 === arguments[1] ? function () {
          } : arguments[1];
          i(this, e), n.reportTouchActivity = !1, t.call(this, null, n, o), this.hasStarted_ = !1, this.on("playing", function () {
            this.hasStarted_ = !0
          }), this.on("loadstart", function () {
            this.hasStarted_ = !1
          }), this.textTracks_ = n.textTracks, this.featuresProgressEvents || this.manualProgressOn(), this.featuresTimeupdateEvents || this.manualTimeUpdatesOn(), (n.nativeCaptions === !1 || n.nativeTextTracks === !1) && (this.featuresNativeTextTracks = !1), this.featuresNativeTextTracks || this.emulateTextTracks(), this.initTextTrackListeners(), this.emitTapEvents()
        }
        ...
        return s(e, t), e.prototype.manualProgressOn = function () {
          ...
          if (e)for (var n = e.length; n--;)this.removeRemoteTextTrack(e[n]);
          ...
          return this.textTracks_ = this.textTracks_ || new h["default"], this.textTracks_
        }, e.prototype.remoteTextTracks = function () {
          return this.remoteTextTracks_ = this.remoteTextTracks_ || new h["default"], this.remoteTextTracks_
        }, e.prototype.addTextTrack = function (t, e, n) {
      ...
      x.prototype.featuresVolumeControl = !0, x.prototype.featuresFullscreenResize = !1, x.prototype.featuresPlaybackRate = !1, x.prototype.featuresProgressEvents = !1, x.prototype.featuresTimeupdateEvents = !1, x.prototype.featuresNativeTextTracks = !1, x.withSourceHandlers = function (t) {
        t.registerSourceHandler = function (e, n) {
          ...
          for (var n = t.sourceHandlers || [], o = void 0, r = 0; r < n.length; r++)if (o = n[r].canHandleSource(e))return n[r];
          return null
      ...
      "../component": 58,
      "../media-error.js": 94,
      "../tracks/text-track": 114,
      "../tracks/text-track-list": 112,
      "../utils/buffer.js": 116,
      "../utils/fn.js": 120,
      "../utils/log.js": 123,
      "../utils/time-ranges.js": 126,
    ...
    108: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var i = t("../utils/browser.js"), s = r(i), a = t("global/document"), l = o(a), u = function c(t) {
        var e = this;
        if (s.IS_IE8) {
      ...
      u.prototype.setCues_ = function (t) {
        ...
        if (o > e)for (n = e; o > n; n++)r.call(this, n)
    ...
    }, {"../utils/browser.js": 115, "global/document": 1}],
    109: [function (t, e, n) {
      "use strict";
      function o(t) {
        if (t && t.__esModule)return t;
      ...
      n.__esModule = !0;
      var u = t("../component"), c = r(u), p = t("../menu/menu.js"), h = (r(p), t("../menu/menu-item.js")), f = (r(h), t("../menu/menu-button.js")), d = (r(f), t("../utils/fn.js")), y = o(d), v = t("global/document"), g = (r(v), t("global/window")), m = r(g), b = "#222", _ = "#ccc", j = {
        monospace: "monospace",
        ...
        return s(e, t), e.prototype.toggleDisplay = function () {
          ...
          if (this.clearDisplay(), t)for (var e = 0; e < t.length; e++) {
            var n = t[e];
    ...
    110: [function (t, e, n) {
      "use strict";
      n.__esModule = !0;
      var o = {disabled: "disabled", hidden: "hidden", showing: "showing"}, r = {
        subtitles: "subtitles",
        captions: "captions",
    ...
    111: [function (t, e, n) {
      ...
      var o = function (t) {
        ...
        var e = t.el().querySelectorAll("track"), n = Array.prototype.map.call(e, function (t) {
          return t.track
      ...
      n["default"] = {textTracksToJson: r, jsonToTextTracks: i, trackToJson_: o}, e.exports = n["default"]
    }, {}],
    112: [function (t, e, n) {
      "use strict";
      function o(t) {
      ...
      n.__esModule = !0;
      var i = t("../event-target"), s = r(i), a = t("../utils/fn.js"), l = o(a), u = t("../utils/browser.js"), c = o(u), p = t("global/document"), h = r(p), f = function y(t) {
        var e = this;
        if (c.IS_IE8) {
          e = h["default"].createElement("custom");
      ...
      f.prototype = Object.create(s["default"].prototype), f.prototype.constructor = f, f.prototype.allowedEvents_ = {
        change: "change",
        addtrack: "addtrack",
        removetrack: "removetrack"
      };
      for (var d in f.prototype.allowedEvents_)f.prototype["on" + d] = null;
      f.prototype.addTrack_ = function (t) {
        ...
        "" + e in this || Object.defineProperty(this, e, {
          ...
          this.trigger("change")
        })), this.tracks_.push(t), this.trigger({type: "addtrack", track: t})
      }, f.prototype.removeTrack_ = function (t) {
        for (var e = void 0, n = 0, o = this.length; o > n; n++)if (e = this[n], e === t) {
          this.tracks_.splice(n, 1);
          break
        }
        this.trigger({type: "removetrack", track: e})
    ...
    }, {"../event-target": 90, "../utils/browser.js": 115, "../utils/fn.js": 120, "global/document": 1}],
    113: [function (t, e, n) {
      "use strict";
      function o(t) {
        if (t && t.__esModule)return t;
      ...
      n.__esModule = !0;
      var c = t("../component"), p = r(c), h = t("../utils/events.js"), f = o(h), d = t("../utils/fn.js"), y = o(d), v = t("../utils/log.js"), g = r(v), m = t("safe-json-parse/tuple"), b = r(m), _ = t("global/window"), j = r(_), T = function (t) {
        function e(n, o) {
          i(this, e), t.call(this, n, o), this.hide(), void 0 === o.persistTextTrackSettings && (this.options_.persistTextTrackSettings = this.options_.playerOptions.persistTextTrackSettings), f.on(this.el().querySelector(".vjs-done-button"), "click", y.bind(this, function () {
            this.saveSettings(), this.hide()
          })), f.on(this.el().querySelector(".vjs-default-button"), "click", y.bind(this, function () {
        ...
        return s(e, t), e.prototype.createEl = function () {
          ...
          var t = this.el(), e = a(t.querySelector(".vjs-edge-style select")), n = a(t.querySelector(".vjs-font-family select")), o = a(t.querySelector(".vjs-fg-color > select")), r = a(t.querySelector(".vjs-text-opacity > select")), i = a(t.querySelector(".vjs-bg-color > select")), s = a(t.querySelector(".vjs-bg-opacity > select")), l = a(t.querySelector(".window-color > select")), u = a(t.querySelector(".vjs-window-opacity > select")), c = j["default"].parseFloat(a(t.querySelector(".vjs-font-percent > select"))), p = {
            backgroundOpacity: s,
            textOpacity: r,
            windowOpacity: u,
            edgeStyle: e,
          ...
          for (var h in p)("" === p[h] || "none" === p[h] || "fontPercent" === h && 1 === p[h]) && delete p[h];
          return p
          ...
          var t = b["default"](j["default"].localStorage.getItem("vjs-text-track-settings")), e = t[0], n = t[1];
    ...
    114: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var i = t("./text-track-cue-list"), s = r(i), a = t("../utils/fn.js"), l = o(a), u = t("../utils/guid.js"), c = o(u), p = t("../utils/browser.js"), h = o(p), f = t("./text-track-enums"), d = o(f), y = t("../utils/log.js"), v = r(y), g = t("../event-target"), m = r(g), b = t("global/document"), _ = r(b), j = t("global/window"), T = r(j), w = t("../utils/url.js"), k = t("xhr"), x = r(k), C = function P() {
        var t = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0];
        ...
        e.tech_ = t.tech;
        var o = d.TextTrackMode[t.mode] || "disabled", r = d.TextTrackKind[t.kind] || "subtitles", i = t.label || "", a = t.language || t.srclang || "", u = t.id || "vjs_text_track_" + c.newGUID();
        ("metadata" === r || "chapters" === r) && (o = "hidden"), e.cues_ = [], e.activeCues_ = [];
        var p = new s["default"](e.cues_), f = new s["default"](e.activeCues_), y = !1, v = l.bind(e, function () {
        ...
        return "disabled" !== o && e.tech_.on("timeupdate", v), Object.defineProperty(e, "kind", {
          ...
          get: function () {
            ...
            if (y = !1, e.length !== this.activeCues_.length)y = !0; else for (var n = 0; n < e.length; n++)-1 === S.call(this.activeCues_, e[n]) && (y = !0);
            return this.activeCues_ = e, f.setCues_(this.activeCues_), f
          }, set: Function.prototype
        }), t.src ? (e.src = t.src, O(t.src, e)) : e.loaded_ = !0, h.IS_IE8 ? e : void 0
      };
      C.prototype = Object.create(m["default"].prototype), C.prototype.constructor = C, C.prototype.allowedEvents_ = {cuechange: "cuechange"}, C.prototype.addCue = function (t) {
      ...
      var E = function M(t, e) {
        ...
        var n = {uri: t}, o = w.isCrossOrigin(t);
        o && (n.cors = o), x["default"](n, l.bind(this, function (t, n, o) {
          return t ? v["default"].error(t, n) : (e.loaded_ = !0, void E(o, e))
        }))
      }, S = function (t, e) {
    ...
    115: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var r = t("global/document"), i = o(r), s = t("global/window"), a = o(s), l = a["default"].navigator.userAgent, u = /AppleWebKit\/([\d.]+)/i.exec(l), c = u ? parseFloat(u.pop()) : null, p = /iPhone/i.test(l);
      n.IS_IPHONE = p;
      var h = /iPad/i.test(l);
      n.IS_IPAD = h;
      var f = /iPod/i.test(l);
    ...
    118: [function (t, e, n) {
      ...
      function a() {
        var t = arguments.length <= 0 || void 0 === arguments[0] ? "div" : arguments[0], e = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1], n = arguments.length <= 2 || void 0 === arguments[2] ? {} : arguments[2], o = w["default"].createElement(t);
        return Object.getOwnPropertyNames(e).forEach(function (t) {
          var n = e[t];
          -1 !== t.indexOf("aria-") || "role" === t || "type" === t ? (S["default"].warn(M["default"](j, t, n)), o.setAttribute(t, n)) : o[t] = n
      ...
      function u(t) {
        var e = t[I];
        return e || (e = t[I] = E.newGUID()), A[e] || (A[e] = {}), A[e]
      }
      ...
      function b(t) {
        ...
        var n = w["default"].documentElement, o = w["default"].body, r = n.clientLeft || o.clientLeft || 0, i = x["default"].pageXOffset || o.scrollLeft, s = e.left + i - r, a = n.clientTop || o.clientTop || 0, l = x["default"].pageYOffset || o.scrollTop, u = e.top + l - a;
        return {left: Math.round(s), top: Math.round(u)}
      }

      function _(t, e) {
        var n = {}, o = b(t), r = t.offsetWidth, i = t.offsetHeight, s = o.top, a = o.left, l = e.pageY, u = e.pageX;
      ...
      n.__esModule = !0, n.getEl = s, n.createEl = a, n.insertElFirst = l, n.getElData = u, n.hasElData = c, n.removeElData = p, n.hasElClass = h, n.addElClass = f, n.removeElClass = d, n.setElAttributes = y, n.getElAttributes = v, n.blockTextSelection = g, n.unblockTextSelection = m, n.findElPosition = b, n.getPointerPosition = _;
      var j = i(["Setting attributes in the second argument of createEl()\n                has been deprecated. Use the third argument instead.\n                createEl(type, properties, attributes). Attempting to set ", " to ", "."], ["Setting attributes in the second argument of createEl()\n                has been deprecated. Use the third argument instead.\n                createEl(type, properties, attributes). Attempting to set ", " to ", "."]), T = t("global/document"), w = r(T), k = t("global/window"), x = r(k), C = t("./guid.js"), E = o(C), O = t("./log.js"), S = r(O), P = t("tsml"), M = r(P), A = {}, I = "vdata" + (new Date).getTime()
    }, {"./guid.js": 122, "./log.js": 123, "global/document": 1, "global/window": 2, tsml: 49}],
    119: [function (t, e, n) {
      "use strict";
      function o(t) {
        return t && t.__esModule ? t : {"default": t}
      ...
      function i(t, e, n) {
        ...
        o.handlers || (o.handlers = {}), o.handlers[e] || (o.handlers[e] = []), n.guid || (n.guid = y.newGUID()), o.handlers[e].push(n), o.dispatcher || (o.disabled = !1, o.dispatcher = function (e, n) {
          if (!o.disabled) {
            ...
            if (r)for (var i = r.slice(0), s = 0, a = i.length; a > s && !e.isImmediatePropagationStopped(); s++)i[s].call(t, e, n)
          }
          ...
          if (o.handlers) {
            ...
            if (e) {
              ...
              if (i) {
                ...
                if (n.guid)for (var a = 0; a < i.length; a++)i[a].guid === n.guid && i.splice(a--, 1);
                c(t, e)
              }
            } else for (var l in o.handlers)r(l)
          }
        }
      }

      function a(t, e, n) {
        var o = f.hasElData(t) ? f.getElData(t) : {}, r = t.parentNode || t.ownerDocument;
        if ("string" == typeof e && (e = {
            type: e,
            target: t
          }), e = u(e), o.dispatcher && o.dispatcher.call(t, e, n), r && !e.isPropagationStopped() && e.bubbles === !0)a.call(null, r, e, n); else if (!r && !e.defaultPrevented) {
          var i = f.getElData(e.target);
      ...
      function u(t) {
        ...
        if (!t || !t.isPropagationStopped) {
          ...
          if (t.target || (t.target = t.srcElement || b["default"]), t.relatedTarget || (t.relatedTarget = t.fromElement === t.target ? t.toElement : t.fromElement), t.preventDefault = function () {
            ...
            var i = b["default"].documentElement, s = b["default"].body;
      ...
      var h = t("./dom.js"), f = r(h), d = t("./guid.js"), y = r(d), v = t("global/window"), g = o(v), m = t("global/document"), b = o(m)
    }, {"./dom.js": 118, "./guid.js": 122, "global/document": 1, "global/window": 2}],
    120: [function (t, e, n) {
      "use strict";
      n.__esModule = !0;
      var o = t("./guid.js"), r = function (t, e, n) {
    ...
    121: [function (t, e, n) {
      ...
      function o(t) {
        ...
        return function () {
          var n = Math.floor(t % 60), o = Math.floor(t / 60 % 60), r = Math.floor(t / 3600), i = Math.floor(e / 60 % 60), s = Math.floor(e / 3600);
    ...
    125: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var r = t("global/document"), i = o(r), s = function (t) {
    ...
    128: [function (t, e, n) {
      ...
      n.__esModule = !0;
      var r = t("global/document"), i = o(r), s = t("global/window"), a = o(s), l = function (t) {
        var e = ["protocol", "hostname", "port", "pathname", "search", "hash", "host"], n = i["default"].createElement("a");
        n.href = t;
        var o = "" === n.host && "file:" !== n.protocol, r = void 0;
      ...
      var p = function (t) {
        var e = l(t), n = a["default"].location, o = ":" === e.protocol ? n.protocol : e.protocol, r = o + e.host !== n.protocol + n.host;
        return r
      };
      n.isCrossOrigin = p
    }, {"global/document": 1, "global/window": 2}],
    129: [function (e, n, o) {
      ...
      o.__esModule = !0;
      {
        var s = e("global/document"), a = i(s), l = e("./setup"), u = r(l), c = e("./utils/stylesheet.js"), p = r(c), h = e("./component"), f = i(h), d = e("./event-target"), y = i(d), v = e("./utils/events.js"), g = r(v), m = e("./player"), b = i(m), _ = e("./plugins.js"), j = i(_), T = e("../../src/js/utils/merge-options.js"), w = i(T), k = e("./utils/fn.js"), x = r(k), C = e("./tracks/text-track.js"), E = i(C), O = e("object.assign"), S = (i(O), e("./utils/time-ranges.js")), P = e("./utils/format-time.js"), M = i(P), A = e("./utils/log.js"), I = i(A), R = e("./utils/dom.js"), D = r(R), F = e("./utils/browser.js"), N = r(F), L = e("./utils/url.js"), B = r(L), H = e("./extend.js"), V = i(H), U = e("lodash-compat/object/merge"), q = i(U), W = e("./utils/create-deprecation-proxy.js"), z = i(W), X = e("xhr"), G = i(X), $ = e("./tech/html5.js"), Y = (i($), e("./tech/flash.js"));
        i(Y)
      }
      ...
      u.autoSetupTimeout(1, K), K.VERSION = "5.0.0", K.options = b["default"].prototype.options_, K.getPlayers = function () {
        return b["default"].players
      }, K.players = z["default"](b["default"].players, {
        get: "Access to videojs.players is deprecated; use videojs.getPlayers instead",
        set: "Modification of videojs.players is deprecated"
      }), K.getComponent = f["default"].getComponent, K.registerComponent = f["default"].registerComponent, K.browser = N, K.TOUCH_ENABLED = N.TOUCH_ENABLED, K.extend = V["default"], K.mergeOptions = w["default"], K.bind = x.bind, K.plugin = j["default"], K.addLanguage = function (t, e) {
        var n;
        return t = ("" + t).toLowerCase(), q["default"](K.options.languages, (n = {}, n[t] = e, n))[t]
      }, K.log = I["default"], K.createTimeRange = K.createTimeRanges = S.createTimeRanges, K.formatTime = M["default"], K.parseUrl = B.parseUrl, K.isCrossOrigin = B.isCrossOrigin, K.EventTarget = y["default"], K.on = g.on, K.one = g.one, K.off = g.off, K.trigger = g.trigger, K.xhr = G["default"], K.TextTrack = E["default"], "function" == typeof t && t.amd ? t("videojs", [], function () {
        return K
      }) : "object" == typeof o && "object" == typeof n && (n.exports = K), o["default"] = K, n.exports = o["default"]
    }, {
      "../../src/js/utils/merge-options.js": 124,
      "./component": 58,
      "./event-target": 90,
      "./extend.js": 91,
      "./player": 98,
      ...
      "./tech/flash.js": 104,
      "./tech/html5.js": 105,
      "./tracks/text-track.js": 114,
      "./utils/browser.js": 115,
      "./utils/create-deprecation-proxy.js": 117,
      "./utils/dom.js": 118,
      "./utils/events.js": 119,
      "./utils/fn.js": 120,
      "./utils/format-time.js": 121,
  ...
  var e = t.vttjs = {}, n = e.VTTCue, o = e.VTTRegion, r = t.VTTCue, i = t.VTTRegion;
  e.shim = function () {
  ...
  function i(t, e, i) {
    ...
    var c = "", p = !1, h = t, f = e, d = i, y = null, v = "", g = !0, m = "auto", b = "start", _ = 50, j = "middle", T = 50, w = "middle";
  ...
  function s(t, e) {
    ...
    for (var l, u = t.document.createElement("div"), c = u, p = []; null !== (l = o());)if ("<" !== l[0])c.appendChild(t.document.createTextNode(i(l))); else {
      if ("/" === l[1]) {
        p.length && p[p.length - 1] === l.substr(2).replace(">", "") && (p.pop(), c = c.parentNode);
        continue
      }
      var h, f = n(l.substr(1, l.length - 2));
      if (f) {
        h = t.document.createProcessingInstruction("timestamp", f), c.appendChild(h);
        continue
      }
      ...
      if (!s(c, h))continue;
      d[2] && (h.className = d[2].substr(1).replace(".", " ")), p.push(d[1]), c.appendChild(h), c = h
    }
    return u
  }
  ...
  function a(t) {
    ...
    function n(t) {
      ...
      var o = t.pop(), r = o.textContent || o.innerText;
      if (r) {
        var i = r.match(/^.*(\n|\r)/);
    ...
    for (e(r, t); i = n(r);)for (var s = 0; s < i.length; s++) {
      o = i.charCodeAt(s);
  ...
  function c(t, e, n) {
    var o = /MSIE\s8\.0/.test(navigator.userAgent), r = "rgba(255, 255, 255, 1)", i = "rgba(0, 0, 0, 0.8)";
    ...
    } : {top: this.formatStyle(c, "%"), height: this.formatStyle(e.size, "%")}), this.move = function (t) {
      this.applyStyles({
  ...
  function h(t, e, n, o) {
    ...
    if (s.snapToLines) {
      ...
      var h = i.lineHeight, f = h * Math.round(a), d = n[c] + h, y = u[0];
      Math.abs(f) > d && (f = 0 > f ? -1 : 1, f *= Math.ceil(d / h) * h), 0 > a && (f += "" === s.vertical ? n.height : n.width, u = u.reverse()), i.move(y, f)
    } else {
  ...
  u.prototype.applyStyles = function (t, e) {
    ...
    var e = Math.max(0, Math.min(this.right, t.right) - Math.max(this.left, t.left)), n = Math.max(0, Math.min(this.bottom, t.bottom) - Math.max(this.top, t.top)), o = e * n;
    ...
    var e = t.div ? t.div.offsetHeight : t.tagName ? t.offsetHeight : 0, n = t.div ? t.div.offsetWidth : t.tagName ? t.offsetWidth : 0, o = t.div ? t.div.offsetTop : t.tagName ? t.offsetTop : 0;
  ...
  f.processCues = function (t, e, n) {
    ...
    if (r.style.position = "absolute", r.style.left = "0", r.style.right = "0", r.style.top = "0", r.style.bottom = "0", r.style.margin = T, n.appendChild(r), o(e)) {
      var i = [], s = p.getSimpleBoxPosition(r), a = Math.round(s.height * _ * 100) / 100, l = {font: a + "px " + j};
      !function () {
        for (var n, o, a = 0; a < e.length; a++)o = e[a], n = new c(t, o, l), r.appendChild(n.div), h(t, n, s, i), o.displayState = n.div, i.push(p.getSimpleBoxPosition(n))
      }()
  ...
  videojs.plugin("playlist", function (e) {
    ...
    var d = function (t) {
      ...
      i = parseInt(t.getAttribute("data-index")) || i, r.src("youtube" == r.techName ? [{
        ...
        type: "audio/mp4",
        src: c + ".m4a"
      }, {type: "audio/webm", src: c + ".webm"}, {type: type = "video/youtube", src: c}, {
        type: "audio/ogg",
        src: c + ".ogg"
      }] : [{type: "video/mp4", src: c + ".mp4"}, {type: type = "video/youtube", src: c}, {
        type: "video/webm",
        src: c + ".webm"
      }]), o && r.play();
    ...
    var y = {
      tracks: a, trackCount: n, play: function () {
        return o
      }, index: function () {
        return i
      }, prev: function () {
...
!function (e, t) {
  ...
  var n, r, a, i = e, o = i.document, l = i.navigator, s = i.setTimeout, c = i.clearTimeout, u = i.setInterval, f = i.clearInterval, d = i.getComputedStyle, p = i.encodeURIComponent, h = i.ActiveXObject, m = i.Error, y = i.Number.parseInt || i.parseInt, v = i.Number.parseFloat || i.parseFloat, g = i.Number.isNaN || i.isNaN, b = i.Date.now, w = i.Object.keys, x = i.Object.defineProperty, C = i.Object.prototype.hasOwnProperty, E = i.Array.prototype.slice, T = function () {
    ...
    for (e = 1, n = l.length; n > e; e++)if (null != (r = l[e]))for (a in r)C.call(r, a) && (i = s[a], o = r[a], s !== o && o !== t && (s[a] = o));
    return s
  }, k = function (e) {
    var t, n, r, a;
    if ("object" != typeof e || null == e || "number" == typeof e.nodeType)t = e; else if ("number" == typeof e.length)for (t = [], n = 0, r = e.length; r > n; n++)C.call(e, n) && (t[n] = k(e[n])); else {
      t = {};
  ...
  }, J = ["flash-unavailable", "flash-degraded", "flash-overdue", "version-mismatch", "config-mismatch", "clipboard-error"], K = ["flash-disabled", "flash-outdated", "flash-sandboxed", "flash-unavailable", "flash-degraded", "flash-deactivated", "flash-overdue"], U = new RegExp("^flash-(" + K.map(function (e) {
      return e.replace(/^flash-/, "")
    }).join("|") + ")$"), W = new RegExp("^flash-(" + K.slice(1).map(function (e) {
      return e.replace(/^flash-/, "")
    }).join("|") + ")$"), G = {
    swfPath: Z(),
    ...
    if ("object" == typeof e && null !== e)for (var t in e)if (C.call(e, t))if (/^(?:forceHandCursor|title|zIndex|bubbleEvents)$/.test(t))G[t] = e[t]; else if (null == X.bridge)if ("containerId" === t || "swfObjectId" === t) {
      if (!pt(e[t]))throw new Error("The specified `" + t + "` value is not valid as an HTML4 Element ID");
      G[t] = e[t]
    } else G[t] = e[t];
    return "string" == typeof e && e ? C.call(G, e) ? G[e] : void 0 : k(G)
  }, Q = function () {
    return Ht(), {
      browser: I(l, ["userAgent", "platform", "appName"]),
      flash: O(X, ["bridge"]),
      zeroclipboard: {version: Jt.version, config: Jt.config()}
    }
  }, et = function () {
    return !!(X.disabled || X.outdated || X.sandboxed || X.unavailable || X.degraded || X.deactivated)
  }, tt = function (e, r) {
    var a, i, o, l = {};
    if ("string" == typeof e && e)o = e.toLowerCase().split(/\s+/); else if ("object" == typeof e && e && "undefined" == typeof r)for (a in e)C.call(e, a) && "string" == typeof a && a && "function" == typeof e[a] && Jt.on(a, e[a]);
    if (o && o.length) {
      for (a = 0, i = o.length; i > a; a++)e = o[a].replace(/^on/, ""), l[e] = !0, Y[e] || (Y[e] = []), Y[e].push(r);
      if (l.ready && X.ready && Jt.emit({type: "ready"}), l.error) {
        for (a = 0, i = K.length; i > a; a++)if (X[K[a].replace(/^flash-/, "")] === !0) {
          Jt.emit({type: "error", name: K[a]});
          break
        }
        n !== t && Jt.version !== n && Jt.emit({
          type: "error",
          name: "version-mismatch",
          jsVersion: Jt.version,
          swfVersion: n
        })
      }
    }
    ...
    var n, r, a, i, o;
    if (0 === arguments.length)i = w(Y); else if ("string" == typeof e && e)i = e.split(/\s+/); else if ("object" == typeof e && e && "undefined" == typeof t)for (n in e)C.call(e, n) && "string" == typeof n && n && "function" == typeof e[n] && Jt.off(n, e[n]);
    if (i && i.length)for (n = 0, r = i.length; r > n; n++)if (e = i[n].toLowerCase().replace(/^on/, ""), o = Y[e], o && o.length)if (t)for (a = o.indexOf(t); -1 !== a;)o.splice(a, 1), a = o.indexOf(t, a); else o.length = 0;
    return Jt
  }, rt = function (e) {
    var t;
    ...
    var t, n, r;
    return e = ht(e), e && !xt(e) ? "ready" === e.type && X.overdue === !0 ? Jt.emit({
      type: "error",
      name: "flash-overdue"
    }) : (t = D({}, e), bt.call(this, t), "copy" === e.type && (r = Ot(B), n = r.data, M = r.formatMap), n) : void 0
  }, it = function () {
    var e = X.sandboxed;
    if (Ht(), "boolean" != typeof X.ready && (X.ready = !1), X.sandboxed !== e && X.sandboxed === !0)X.ready = !1, Jt.emit({
      type: "error",
      name: "flash-sandboxed"
    }); else if (!Jt.isFlashUnusable() && null === X.bridge) {
      var t = G.flashLoadTimeout;
      "number" == typeof t && t >= 0 && (P = s(function () {
        "boolean" != typeof X.deactivated && (X.deactivated = !0), X.deactivated === !0 && Jt.emit({
          type: "error",
    ...
    Jt.clearData(), Jt.blur(), Jt.emit("destroy"), It(), Jt.off()
  }, lt = function (e, t) {
    var n;
    if ("object" == typeof e && e && "undefined" == typeof t)n = e, Jt.clearData(); else {
    ...
    if (e && 1 === e.nodeType) {
      r && (Zt(r, G.activeClass), r !== e && Zt(r, G.hoverClass)), r = e, zt(e, G.hoverClass);
      var t = e.getAttribute("title") || G.title;
      if ("string" == typeof t && t) {
        var n = Dt(X.bridge);
        n && n.setAttribute("title", t)
      }
      var a = G.forceHandCursor === !0 || "pointer" === Vt(e, "cursor");
      Mt(a), Bt()
    }
  }, ft = function () {
    var e = Dt(X.bridge);
    e && (e.removeAttribute("title"), e.style.left = "0px", e.style.top = "-9999px", e.style.width = "1px", e.style.height = "1px"), r && (Zt(r, G.hoverClass), Zt(r, G.activeClass), r = null)
  }, dt = function () {
    return r || null
  }, pt = function (e) {
    ...
    if ("string" == typeof e && e ? (t = e, e = {}) : "object" == typeof e && e && "string" == typeof e.type && e.type && (t = e.type), t) {
      ...
      return "error" === e.type && e.name && n && (n = n[e.name]), n && (e.message = n), "ready" === e.type && D(e, {
        ...
        target: null,
        minimumVersion: $
      }), W.test(e.name) && D(e, {version: X.version})), "copy" === e.type && (e.clipboardData = {
        setData: Jt.setData,
        clearData: Jt.clearData
      }), "aftercopy" === e.type && (e = Nt(e, M)), e.target && !e.relatedTarget && (e.relatedTarget = mt(e.target)), yt(e)
    }
  }, mt = function (e) {
    ...
    if ("object" == typeof e && e && e.type) {
      var t = vt(e), n = Y["*"] || [], r = Y[e.type] || [], a = n.concat(r);
      if (a && a.length) {
        var o, l, s, c, u, f = this;
        for (o = 0, l = a.length; l > o; o++)s = a[o], c = f, "string" == typeof s && "function" == typeof i[s] && (s = i[s]), "object" == typeof s && s && "function" == typeof s.handleEvent && (c = s, s = s.handleEvent), "function" == typeof s && (u = D({}, e), gt(s, c, [u], t))
      }
      return this
    }
  }, wt = function (e) {
    var t = null;
    return (V === !1 || e && "error" === e.type && e.name && -1 !== J.indexOf(e.name)) && (t = !1), t
  }, xt = function (e) {
    var t = e.target || r || null, i = "swf" === e._source;
    switch (delete e._source, e.type) {
      case"error":
        var o = "flash-sandboxed" === e.name || wt(e);
        "boolean" == typeof o && (X.sandboxed = o), -1 !== K.indexOf(e.name) ? D(X, {
      ...
      case"copy":
        ...
        !B["text/html"] && !B["text/plain"] && u && (c = u.value || u.outerHTML || u.innerHTML) && (s = u.value || u.textContent || u.innerText) ? (e.clipboardData.clearData(), e.clipboardData.setData("text/plain", s), c !== s && e.clipboardData.setData("text/html", c)) : !B["text/plain"] && e.target && (s = e.target.getAttribute("data-clipboard-text")) && (e.clipboardData.clearData(), e.clipboardData.setData("text/plain", s));
        break;
      case"aftercopy":
        Ct(e), Jt.clearData(), t && t !== St() && t.focus && t.focus();
        break;
      case"_mouseover":
        Jt.focus(t), G.bubbleEvents === !0 && i && (t && t !== e.relatedTarget && !L(e.relatedTarget, t) && Et(D({}, e, {
          type: "mouseenter",
          bubbles: !1,
          cancelable: !1
        })), Et(D({}, e, {type: "mouseover"})));
        break;
      case"_mouseout":
        Jt.blur(), G.bubbleEvents === !0 && i && (t && t !== e.relatedTarget && !L(e.relatedTarget, t) && Et(D({}, e, {
          type: "mouseleave",
          bubbles: !1,
          cancelable: !1
        })), Et(D({}, e, {type: "mouseout"})));
        break;
      case"_mousedown":
        zt(t, G.activeClass), G.bubbleEvents === !0 && i && Et(D({}, e, {type: e.type.slice(1)}));
        break;
      case"_mouseup":
        Zt(t, G.activeClass), G.bubbleEvents === !0 && i && Et(D({}, e, {type: e.type.slice(1)}));
        break;
      case"_click":
        a = null, G.bubbleEvents === !0 && i && Et(D({}, e, {type: e.type.slice(1)}));
        break;
      case"_mousemove":
        G.bubbleEvents === !0 && i && Et(D({}, e, {type: e.type.slice(1)}))
    }
    return /^_(?:click|mouse(?:over|out|down|up|move))$/.test(e.type) ? !0 : void 0
  }, Ct = function (e) {
    if (e.errors && e.errors.length > 0) {
      var t = k(e);
      D(t, {type: "error", name: "clipboard-error"}), delete t.success, s(function () {
        Jt.emit(t)
      }, 0)
    }
  }, Et = function (e) {
    ...
    if ("number" == typeof e && e >= 0) {
      ...
      H = u(function () {
        ...
        $t(e) && (Yt(), X.deactivated = null, Jt.emit({type: "error", name: "swf-not-found"}))
      }, t)
    }
  }, jt = function () {
    var e = o.createElement("div");
    return e.id = G.containerId, e.className = G.containerClass, e.style.position = "absolute", e.style.left = "0px", e.style.top = "-9999px", e.style.width = "1px", e.style.height = "1px", e.style.zIndex = "" + Pt(G.zIndex), e
  }, Dt = function (e) {
    for (var t = e && e.parentNode; t && "OBJECT" === t.nodeName && t.parentNode;)t = t.parentNode;
    return t || null
  }, kt = function () {
    var e, t = X.bridge, n = Dt(t);
    if (!t) {
      var r = Ft(i.location.host, G), a = "never" === r ? "none" : "all", l = At(D({jsVersion: Jt.version}, G)), s = G.swfPath + Lt(G.swfPath, G);
      n = jt();
    ...
    if (e) {
      ...
      }()) : (e.parentNode && e.parentNode.removeChild(e), r.parentNode && r.parentNode.removeChild(r))), Yt(), X.ready = null, X.bridge = null, X.deactivated = null, n = t
    }
  }, Ot = function (e) {
    var t = {}, n = {};
    ...
    var t, n, r, a, o = "", l = [];
    if (e.trustedDomains && ("string" == typeof e.trustedDomains ? a = [e.trustedDomains] : "object" == typeof e.trustedDomains && "length"in e.trustedDomains && (a = e.trustedDomains)), a && a.length)for (t = 0, n = a.length; n > t; t++)if (C.call(a, t) && a[t] && "string" == typeof a[t]) {
      if (r = _t(a[t]), !r)continue;
      if ("*" === r) {
        l.length = 0, l.push(r);
        break
      }
    ...
    var e = function (e) {
      ...
      for (t = 0, n = e.length; n > t; t++)if (C.call(e, t) && (r = _t(e[t]))) {
        if ("*" === r) {
          a.length = 0, a.push("*");
          break
        }
    ...
    var n, r, a, i = [];
    if ("string" == typeof t && t && (i = t.split(/\s+/)), e && 1 === e.nodeType && i.length > 0)if (e.classList)for (n = 0, r = i.length; r > n; n++)e.classList.add(i[n]); else if (e.hasOwnProperty("className")) {
      for (a = " " + e.className + " ", n = 0, r = i.length; r > n; n++)-1 === a.indexOf(" " + i[n] + " ") && (a += i[n] + " ");
      e.className = a.replace(/^\s+|\s+$/g, "")
    }
    return e
  }, Zt = function (e, t) {
    var n, r, a, i = [];
    if ("string" == typeof t && t && (i = t.split(/\s+/)), e && 1 === e.nodeType && i.length > 0)if (e.classList && e.classList.length > 0)for (n = 0, r = i.length; r > n; n++)e.classList.remove(i[n]); else if (e.className) {
      for (a = (" " + e.className + " ").replace(/[\r\n\t]/g, " "), n = 0, r = i.length; r > n; n++)a = a.replace(" " + i[n] + " ", " ");
      e.className = a.replace(/^\s+|\s+$/g, "")
    }
    return e
  }, Vt = function (e, t) {
    ...
    if (e.getBoundingClientRect) {
      ...
      if ("relative" === Vt(o.body, "position")) {
        var f = o.body.getBoundingClientRect(), d = o.documentElement.getBoundingClientRect();
        c = f.left - d.left || 0, u = f.top - d.top || 0
      }
      t.left = n.left + r - l - c, t.top = n.top + a - s - u, t.width = "width"in n ? n.width : n.right - n.left, t.height = "height"in n ? n.height : n.bottom - n.top
    }
    return t
  }, $t = function (e) {
    if (!e)return !1;
    var t = d(e, null), n = v(t.height) > 0, r = v(t.width) > 0, a = v(t.top) >= 0, i = v(t.left) >= 0, o = n && r && a && i, l = o ? null : Xt(e), s = "none" !== t.display && "collapse" !== t.visibility && (o || !!l && (n || l.height > 0) && (r || l.width > 0) && (a || l.top >= 0) && (i || l.left >= 0));
    return s
  }, Yt = function () {
    c(P), P = 0, f(H), H = 0
  }, Bt = function () {
    ...
    var t;
    return "number" != typeof e || g(e) ? "string" == typeof e && (t = Pt(y(e, 10))) : t = e, "number" == typeof t ? t : "auto"
  }, Ht = function (t) {
    var n, r, a, i = X.sandboxed, o = null;
    if (t = t === !0, V === !1)o = !1; else {
      try {
        r = e.frameElement || null
      } catch (l) {
        a = {name: l.name, message: l.message}
      }
    ...
    return X.sandboxed = o, i === o || t || Rt(h), o
  }, Rt = function (e) {
    function t(e) {
      var t = e.match(/[\d]+/g);
    ...
    if (l.plugins && l.plugins.length)a = l.plugins["Shockwave Flash"], r(a), l.plugins["Shockwave Flash 2.0"] && (s = !0, f = "2.0.0.11"); else if (l.mimeTypes && l.mimeTypes.length)o = l.mimeTypes["application/x-shockwave-flash"], a = o && o.enabledPlugin, r(a); else if ("undefined" != typeof e) {
      c = !0;
      try {
    ...
    X.disabled = s !== !0, X.outdated = f && v(f) < v($), X.version = f || "0.0.0", X.pluginType = u ? "pepper" : c ? "activex" : s ? "netscape" : "unknown"
  };
  Rt(h), Ht(!0);
  var Jt = function () {
    return this instanceof Jt ? void("function" == typeof Jt._createClient && Jt._createClient.apply(this, j(arguments))) : new Jt
  };
  x(Jt, "version", {value: "2.2.0", writable: !1, configurable: !0, enumerable: !0}), Jt.config = function () {
  ...
  var Kt = 0, Ut = {}, Wt = 0, Gt = {}, qt = {};
  D(G, {autoActivate: !0});
  var Qt = function (e) {
    var t = this;
    t.id = "" + Kt++, Ut[t.id] = {instance: t, elements: [], handlers: {}}, e && t.clip(e), Jt.on("*", function (e) {
      return t.emit(e)
    }), Jt.on("destroy", function () {
      t.destroy()
    }), Jt.create()
  }, en = function (e, r) {
    var a, i, o, l = {}, s = Ut[this.id], c = s && s.handlers;
    ...
    if (o && o.length) {
      ...
      if (l.ready && X.ready && this.emit({type: "ready", client: this}), l.error) {
        for (a = 0, i = K.length; i > a; a++)if (X[K[a].replace(/^flash-/, "")]) {
          this.emit({type: "error", name: K[a], client: this});
          break
        }
        n !== t && Jt.version !== n && this.emit({
          type: "error",
          name: "version-mismatch",
          jsVersion: Jt.version,
          swfVersion: n
    ...
    var n, r, a, i, o, l = Ut[this.id], s = l && l.handlers;
    if (!s)return this;
    ...
    if (i && i.length)for (n = 0, r = i.length; r > n; n++)if (e = i[n].toLowerCase().replace(/^on/, ""), o = s[e], o && o.length)if (t)for (a = o.indexOf(t); -1 !== a;)o.splice(a, 1), a = o.indexOf(t, a); else o.length = 0;
    return this
  }, nn = function (e) {
    var t = null, n = Ut[this.id] && Ut[this.id].handlers;
    return n && (t = "string" == typeof e && e ? n[e] ? n[e].slice(0) : [] : k(n)), t
  }, rn = function (e) {
    if (cn.call(this, e)) {
      "object" == typeof e && e && "string" == typeof e.type && e.type && (e = D({}, e));
      var t = D({}, ht(e), {client: this});
      un.call(this, t)
    }
    return this
  }, an = function (e) {
    if (!Ut[this.id])throw new Error("Attempted to clip element(s) to a destroyed ZeroClipboard client instance");
    e = fn(e);
    for (var t = 0; t < e.length; t++)if (C.call(e, t) && e[t] && 1 === e[t].nodeType) {
      e[t].zcClippingId ? -1 === Gt[e[t].zcClippingId].indexOf(this.id) && Gt[e[t].zcClippingId].push(this.id) : (e[t].zcClippingId = "zcClippingId_" + Wt++, Gt[e[t].zcClippingId] = [this.id], G.autoActivate === !0 && dn(e[t]));
      var n = Ut[this.id] && Ut[this.id].elements;
    ...
    Ut[this.id] && (this.unclip(), this.off(), delete Ut[this.id])
  }, cn = function (e) {
    if (!e || !e.type)return !1;
    if (e.client && e.client !== this)return !1;
    var t = Ut[this.id], n = t && t.elements, r = !!n && n.length > 0, a = !e.target || r && -1 !== n.indexOf(e.target), i = e.relatedTarget && r && -1 !== n.indexOf(e.relatedTarget), o = e.client && e.client === this;
    return t && (a || i || o) ? !0 : !1
  }, un = function (e) {
    var t = Ut[this.id];
    if ("object" == typeof e && e && e.type && t) {
      var n = vt(e), r = t && t.handlers["*"] || [], a = t && t.handlers[e.type] || [], o = r.concat(a);
      if (o && o.length) {
        var l, s, c, u, f, d = this;
        for (l = 0, s = o.length; s > l; l++)c = o[l], u = d, "string" == typeof c && "function" == typeof i[c] && (c = i[c]), "object" == typeof c && c && "function" == typeof c.handleEvent && (u = c, c = c.handleEvent), "function" == typeof c && (f = D({}, e), gt(c, u, [f], n))
      }
    }
  }, fn = function (e) {
    ...
    if (e && 1 === e.nodeType) {
      ...
      e.addEventListener("mouseover", n, !1), e.addEventListener("mouseout", t, !1), e.addEventListener("mouseenter", t, !1), e.addEventListener("mouseleave", t, !1), e.addEventListener("mousemove", t, !1), qt[e.zcClippingId] = {
        mouseover: n,
        mouseout: t,
        mouseenter: t,
        mouseleave: t,
    ...
    if (e && 1 === e.nodeType) {
      var t = qt[e.zcClippingId];
      if ("object" == typeof t && t) {
        for (var n, r, a = ["move", "leave", "enter", "out", "over"], i = 0, o = a.length; o > i; i++)n = "mouse" + a[i], r = t[n], "function" == typeof r && e.removeEventListener(n, r, !1);
        delete qt[e.zcClippingId]
      }
    }
  };
  Jt._createClient = function () {
    Qt.apply(this, j(arguments))
  }, Jt.prototype.on = function () {
    return en.apply(this, j(arguments))
  }, Jt.prototype.off = function () {
    return tn.apply(this, j(arguments))
    ...
    if (!Ut[this.id])throw new Error("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance");
    ...
    if (!Ut[this.id])throw new Error("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance");
    return Jt.setData.apply(this, j(arguments)), this
  }, Jt.prototype.clearData = function () {
    if (!Ut[this.id])throw new Error("Attempted to clear pending clipboard data from a destroyed ZeroClipboard client instance");
    return Jt.clearData.apply(this, j(arguments)), this
  }, Jt.prototype.getData = function () {
    if (!Ut[this.id])throw new Error("Attempted to get pending clipboard data from a destroyed ZeroClipboard client instance");
    return Jt.getData.apply(this, j(arguments))
...
!function (e) {
  "use strict";
  ZeroClipboard.config({swfPath: "./swf/ZeroClipboard.swf"}), function () {
    e(window).load(function () {
      var t = e(".js-copy-to-clipboard"), n = new ZeroClipboard(t);
      ZeroClipboard.on("error", function () {
        t.click(function () {
          var t, n, i = e(this), a = document, o = i.parent().find("code")[0];
          o && (a.body.createTextRange ? (t = document.body.createTextRange(), t.moveToElementText(o), t.select()) : window.getSelection && (n = window.getSelection(), t = document.createRange(), t.selectNodeContents(o), n.removeAllRanges(), n.addRange(t)))
        })
      }), n.on("ready", function () {
        n.on("copy", function (t) {
          var n = t.clipboardData, i = e("code", e(t.target).parent());
          n.setData("text/plain", i.text())
        }), n.on("aftercopy", function (t) {
          var n = e(t.target);
          n.text("copied"), setTimeout(function () {
            n.text("copy")
          }, 700)
        })
      })
    ...
    e(".js-file-tree").each(function () {
      var t = e(this), n = t.data("expanded");
    ...
    e(".js-open-modal").click(function (t) {
      t.preventDefault();
      var n = e(this), i = e(n.data("target")), a = n.data("config"), o = {closeClass: "js-close-modal-button"};
      e.extend(o, a), i.bPopup(o)
    })
  }(), function () {
    e(".js-ba").twentytwenty()
  }(), function () {
    var t = e(".js-faq-filter"), n = e(".js-faq");
    t.each(function () {
      var t = e(this), n = t.find("input"), i = t.data("target");
      "undefined" != typeof i && n.fastLiveFilter(i, {selector: e(i).find(".faq-question")})
    }), n.each(function () {
      var t = e(this), n = t.find(".faq-question");
      n.click(function (t) {
        t.preventDefault();
        var n = e(this), i = n.closest(".faq-item"), a = e(".faq-answer", i);
    ...
    t.each(function () {
      var n = e(this), i = {headerTag: "h4", transitionEffect: "fade", labels: {current: ""}}, a = n.data("config");
    ...
    t.each(function () {
      var t = e(this), n = {apiKey: t.data("api")}, i = t.data("config");
    ...
    t.each(function () {
      ...
      e.extend(!0, n, i), t.slicknav(n), t.superfish({
        ...
        speed: "fast",
        disableHI: !0
      }), t.hasClass("menu-light") && e(".slicknav_menu").addClass("menu-light")
    })
  }(), function () {
    e(document).ready(function () {
      var t = "left", n = e(".js-menu-side");
      "right" === n.data("position") && (t = "right"), n.sidr({source: ".js-menu-side-content", side: t})
    })
  }(), function () {
    var t = e(".js-menu-vertical"), n = e(".js-menu-fixed"), i = function (t, n) {
      var i = e(window).scrollTop(), a = t.parent().outerHeight(), o = t.outerHeight(), s = i - n + o;
      i > n && a >= s ? t.addClass("menu-fixed").removeClass("menu-bottom") : i > n && s > a ? t.removeClass("menu-fixed").addClass("menu-bottom") : t.removeClass("menu-fixed menu-bottom")
    };
    t.each(function () {
      var t = e(this), n = t.closest(".js-menu-fixed"), a = t.offset().top;
      t.tendina({
        animate: !1, activeMenu: ".selected", openCallback: function () {
          i(n, a)
        }
      })
    }), n.each(function () {
      var t = e(this), n = t.offset().top;
    ...
    t.each(function () {
      var t = e(this), n = t.closest(".js-search-minimal"), i = n.find(".js-search-minimal-input");
      t.click(function () {
    ...
    t.click(function (t) {
      t.preventDefault(), e("html, body").animate({scrollTop: "0px"})
    })
  }(), function () {
    function t() {
    ...
    var n, i = e(".js-full-page"), a = e(window).height();
    ...
    t.each(function () {
      var t = e(this), n = t.data("target");
      "undefined" != typeof n && e(n).length && t.click(function (t) {
        t.preventDefault(), e("html, body").animate({scrollTop: e(n).first().offset().top}, 1e3)
      })
    })
  }(), function () {
    var t = e(".js-docs-version"), n = t.find(".js-docs-current-version"), i = t.find(".js-docs-version-list");
    n.click(function (e) {
      e.preventDefault(), i.is(":visible") ? i.fadeOut("fast") : i.fadeIn("fast")
    })
  }(), function () {
    var t = e(".js-note");
    t.each(function () {
      var t = e(this), n = t.find(".js-close");
      n.click(function (e) {
        e.preventDefault(), t.fadeOut()
      })
    })
  }(), function () {
    var t = e(".js-grid-view"), n = t.find(".js-grid-view-elem");
    n.responsiveEqualHeightGrid()
  }(), function () {
    var t = e(".js-steps-slider");
    t.owlCarousel({items: 1, margin: 5, nav: !0, navText: ["&#xf104;", "&#xf105;"], navSpeed: 600, dragEndSpeed: 600})
  }(), function () {
    var t = e(".js-gif-player");
    t.gifplayer({label: "&#xf04b;"})
  }(), function () {
    var t = e(".js-rotator");
    t.Morphext({animation: "bounceIn", separator: ",", speed: 2e3})
  }(), function () {
    ...
    t.each(function () {
      var t = e(this), n = t.find(".js-languages-list");
    ...
    var t = e(".js-parallax");
    t.each(function () {
      var t = e(this), n = t.outerHeight(), i = .4 * n;
      t.css("background-size", "120%"), e(window).scroll(function () {
        var a = e(window).scrollTop(), o = t.offset().top + n, s = 100 * a / n, c = -(i * s) / 100;
        o > a && t.css("background-position", "center " + c + "px")
      })
    })
  }(), function () {
    var t = e(".js-animate-number"), n = function (t) {
      if (t.data("animated") !== !0) {
        var n = e(window).scrollTop() + e(window).outerHeight(), i = t.offset().top + t.outerHeight();
    ...
    var t = e(".js-info");
    t.each(function () {
      var t = e(this), n = t.find(".js-info-close");
      n.click(function (e) {
    ...
    t.each(function () {
      var t = e(this), n = t.find(".js-changelog-item"), i = t.find(".js-changelog-input").instaFilta({
        scope: ".js-changelog",
        targets: ".js-changelog-update-description"
      }), a = t.find(".js-changelog-checkbox");
      n.each(function () {
        var t = e(this), n = t.find(".js-changelog-switch");
        n.click(function (e) {
    ...
    t.each(function () {
      var t = e(this), n = t.attr("id"), i = t.data("config");
      videojs(n).ready(function () {
        var e = this;
        i ? e.playlist(i) : e.playlist()
      })
    })
  }(), function () {
    e(window).load(function () {
      var t = e(".js-fragment-identifier"), n = new ZeroClipboard(t);
      n.on("ready", function () {
        n.on("copy", function (t) {
          var n = t.clipboardData, i = window.location.host + window.location.pathname + e(t.target).attr("href");
          n.setData("text/plain", i)
        }), n.on("aftercopy", function (t) {
          var n = e(t.target);
          n.addClass("fragment-identifier-copied"), setTimeout(function () {
            n.removeClass("fragment-identifier-copied")
          }, 1e3)
        })
      }), ZeroClipboard.on("error", function () {
        t.click(function () {
          var t = e(this);
          t.addClass("fragment-identifier-error"), setTimeout(function () {
            t.removeClass("fragment-identifier-error")
          }, 1e3)
        })
      }), t.click(function (t) {
        t.preventDefault();
        var n = e(this), i = n.attr("href");
        n.hasClass("fragment-identifier-scroll") && e("html, body").animate({scrollTop: e(i).offset().top}, 500, function () {
